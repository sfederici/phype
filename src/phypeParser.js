...
var act_tab = new Array(
    ...
    /* State 3 */ new Array( 48/* "InternalNonScript" */,8 , 38/* "//" */,9 , 2/* "IF" */,13 , 4/* "WHILE" */,14 , 5/* "DO" */,15 , 6/* "ECHO" */,16 , 39/* "Variable" */,17 , 13/* "{" */,18 , 9/* "ClassToken" */,19 , 40/* "FunctionName" */,20 , 7/* "RETURN" */,21 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 4 */ new Array( 47/* "ScriptEnd" */,44 , 48/* "InternalNonScript" */,8 , 38/* "//" */,9 , 2/* "IF" */,13 , 4/* "WHILE" */,14 , 5/* "DO" */,15 , 6/* "ECHO" */,16 , 39/* "Variable" */,17 , 13/* "{" */,18 , 9/* "ClassToken" */,19 , 40/* "FunctionName" */,20 , 7/* "RETURN" */,21 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 5 */ new Array( 47/* "ScriptEnd" */,-30 , 48/* "InternalNonScript" */,-30 , 38/* "//" */,-30 , 7/* "RETURN" */,-30 , 39/* "Variable" */,-30 , 2/* "IF" */,-30 , 4/* "WHILE" */,-30 , 5/* "DO" */,-30 , 6/* "ECHO" */,-30 , 13/* "{" */,-30 , 9/* "ClassToken" */,-30 , 40/* "FunctionName" */,-30 , 34/* "(" */,-30 , 8/* "NewToken" */,-30 , 45/* "Identifier" */,-30 , 31/* "-" */,-30 , 21/* "!" */,-30 , 41/* "String" */,-30 , 42/* "Integer" */,-30 , 43/* "Boolean" */,-30 , 44/* "Float" */,-30 , 14/* "}" */,-30 ),
    /* State 6 */ new Array( 47/* "ScriptEnd" */,-31 , 48/* "InternalNonScript" */,-31 , 38/* "//" */,-31 , 7/* "RETURN" */,-31 , 39/* "Variable" */,-31 , 2/* "IF" */,-31 , 4/* "WHILE" */,-31 , 5/* "DO" */,-31 , 6/* "ECHO" */,-31 , 13/* "{" */,-31 , 9/* "ClassToken" */,-31 , 40/* "FunctionName" */,-31 , 34/* "(" */,-31 , 8/* "NewToken" */,-31 , 45/* "Identifier" */,-31 , 31/* "-" */,-31 , 21/* "!" */,-31 , 41/* "String" */,-31 , 42/* "Integer" */,-31 , 43/* "Boolean" */,-31 , 44/* "Float" */,-31 , 14/* "}" */,-31 ),
    /* State 7 */ new Array( 47/* "ScriptEnd" */,-32 , 48/* "InternalNonScript" */,-32 , 38/* "//" */,-32 , 7/* "RETURN" */,-32 , 39/* "Variable" */,-32 , 2/* "IF" */,-32 , 4/* "WHILE" */,-32 , 5/* "DO" */,-32 , 6/* "ECHO" */,-32 , 13/* "{" */,-32 , 9/* "ClassToken" */,-32 , 40/* "FunctionName" */,-32 , 34/* "(" */,-32 , 8/* "NewToken" */,-32 , 45/* "Identifier" */,-32 , 31/* "-" */,-32 , 21/* "!" */,-32 , 41/* "String" */,-32 , 42/* "Integer" */,-32 , 43/* "Boolean" */,-32 , 44/* "Float" */,-32 , 14/* "}" */,-32 ),
    /* State 8 */ new Array( 47/* "ScriptEnd" */,-33 , 48/* "InternalNonScript" */,-33 , 38/* "//" */,-33 , 7/* "RETURN" */,-33 , 39/* "Variable" */,-33 , 2/* "IF" */,-33 , 4/* "WHILE" */,-33 , 5/* "DO" */,-33 , 6/* "ECHO" */,-33 , 13/* "{" */,-33 , 9/* "ClassToken" */,-33 , 40/* "FunctionName" */,-33 , 34/* "(" */,-33 , 8/* "NewToken" */,-33 , 45/* "Identifier" */,-33 , 31/* "-" */,-33 , 21/* "!" */,-33 , 41/* "String" */,-33 , 42/* "Integer" */,-33 , 43/* "Boolean" */,-33 , 44/* "Float" */,-33 , 14/* "}" */,-33 ),
    /* State 9 */ new Array( 45/* "Identifier" */,46 , 47/* "ScriptEnd" */,-39 , 48/* "InternalNonScript" */,-39 , 38/* "//" */,-39 , 7/* "RETURN" */,-39 , 39/* "Variable" */,-39 , 2/* "IF" */,-39 , 4/* "WHILE" */,-39 , 5/* "DO" */,-39 , 6/* "ECHO" */,-39 , 13/* "{" */,-39 , 9/* "ClassToken" */,-39 , 40/* "FunctionName" */,-39 , 34/* "(" */,-39 , 8/* "NewToken" */,-39 , 31/* "-" */,-39 , 21/* "!" */,-39 , 41/* "String" */,-39 , 42/* "Integer" */,-39 , 43/* "Boolean" */,-39 , 44/* "Float" */,-39 ),
    /* State 10 */ new Array( 17/* ";" */,47 ),
    /* State 11 */ new Array( 17/* ";" */,48 , 19/* "." */,-46 ),
    /* State 12 */ new Array( 19/* "." */,49 , 17/* ";" */,50 ),
    /* State 13 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 14 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 15 */ new Array( 2/* "IF" */,13 , 4/* "WHILE" */,14 , 5/* "DO" */,15 , 6/* "ECHO" */,16 , 39/* "Variable" */,17 , 13/* "{" */,18 , 7/* "RETURN" */,21 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 16 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 17 */ new Array( 20/* "=" */,58 , 15/* "[" */,59 , 36/* "->" */,-89 , 17/* ";" */,-89 , 22/* "==" */,-89 , 29/* "<" */,-89 , 28/* ">" */,-89 , 26/* "<=" */,-89 , 27/* ">=" */,-89 , 23/* "!=" */,-89 , 31/* "-" */,-89 , 30/* "+" */,-89 , 33/* "*" */,-89 , 32/* "/" */,-89 , 34/* "(" */,-89 , 19/* "." */,-89 ),
    /* State 18 */ new Array( 48/* "InternalNonScript" */,8 , 38/* "//" */,9 , 2/* "IF" */,13 , 4/* "WHILE" */,14 , 5/* "DO" */,15 , 6/* "ECHO" */,16 , 39/* "Variable" */,17 , 13/* "{" */,18 , 9/* "ClassToken" */,19 , 40/* "FunctionName" */,20 , 7/* "RETURN" */,21 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 19 */ new Array( 45/* "Identifier" */,61 ),
    /* State 20 */ new Array( 34/* "(" */,62 ),
    /* State 21 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 , 17/* ";" */,-44 ),
    /* State 22 */ new Array( 34/* "(" */,64 , 36/* "->" */,65 , 17/* ";" */,-95 , 22/* "==" */,-95 , 29/* "<" */,-95 , 28/* ">" */,-95 , 26/* "<=" */,-95 , 27/* ">=" */,-95 , 23/* "!=" */,-95 , 31/* "-" */,-95 , 30/* "+" */,-95 , 33/* "*" */,-95 , 32/* "/" */,-95 , 19/* "." */,-95 , 7/* "RETURN" */,-95 , 39/* "Variable" */,-95 , 2/* "IF" */,-95 , 4/* "WHILE" */,-95 , 5/* "DO" */,-95 , 6/* "ECHO" */,-95 , 13/* "{" */,-95 , 8/* "NewToken" */,-95 , 45/* "Identifier" */,-95 , 21/* "!" */,-95 , 41/* "String" */,-95 , 42/* "Integer" */,-95 , 43/* "Boolean" */,-95 , 44/* "Float" */,-95 , 35/* ")" */,-95 , 18/* "," */,-95 , 16/* "]" */,-95 ),
    /* State 23 */ new Array( 17/* ";" */,-54 , 19/* "." */,-54 , 7/* "RETURN" */,-54 , 39/* "Variable" */,-54 , 2/* "IF" */,-54 , 4/* "WHILE" */,-54 , 5/* "DO" */,-54 , 6/* "ECHO" */,-54 , 13/* "{" */,-54 , 34/* "(" */,-54 , 8/* "NewToken" */,-54 , 45/* "Identifier" */,-54 , 31/* "-" */,-54 , 21/* "!" */,-54 , 41/* "String" */,-54 , 42/* "Integer" */,-54 , 43/* "Boolean" */,-54 , 44/* "Float" */,-54 , 35/* ")" */,-54 , 18/* "," */,-54 , 22/* "==" */,-54 , 29/* "<" */,-54 , 28/* ">" */,-54 , 26/* "<=" */,-54 , 27/* ">=" */,-54 , 23/* "!=" */,-54 , 30/* "+" */,-54 , 33/* "*" */,-54 , 32/* "/" */,-54 , 16/* "]" */,-54 , 36/* "->" */,-54 ),
    /* State 24 */ new Array( 17/* ";" */,-55 , 19/* "." */,-55 , 7/* "RETURN" */,-55 , 39/* "Variable" */,-55 , 2/* "IF" */,-55 , 4/* "WHILE" */,-55 , 5/* "DO" */,-55 , 6/* "ECHO" */,-55 , 13/* "{" */,-55 , 34/* "(" */,-55 , 8/* "NewToken" */,-55 , 45/* "Identifier" */,-55 , 31/* "-" */,-55 , 21/* "!" */,-55 , 41/* "String" */,-55 , 42/* "Integer" */,-55 , 43/* "Boolean" */,-55 , 44/* "Float" */,-55 , 35/* ")" */,-55 , 18/* "," */,-55 , 22/* "==" */,-55 , 29/* "<" */,-55 , 28/* ">" */,-55 , 26/* "<=" */,-55 , 27/* ">=" */,-55 , 23/* "!=" */,-55 , 30/* "+" */,-55 , 33/* "*" */,-55 , 32/* "/" */,-55 , 16/* "]" */,-55 , 36/* "->" */,-55 ),
    /* State 25 */ new Array( 36/* "->" */,-51 , 34/* "(" */,-51 , 17/* ";" */,-51 , 22/* "==" */,-51 , 29/* "<" */,-51 , 28/* ">" */,-51 , 26/* "<=" */,-51 , 27/* ">=" */,-51 , 23/* "!=" */,-51 , 31/* "-" */,-51 , 30/* "+" */,-51 , 33/* "*" */,-51 , 32/* "/" */,-51 , 19/* "." */,-51 , 7/* "RETURN" */,-51 , 39/* "Variable" */,-51 , 2/* "IF" */,-51 , 4/* "WHILE" */,-51 , 5/* "DO" */,-51 , 6/* "ECHO" */,-51 , 13/* "{" */,-51 , 8/* "NewToken" */,-51 , 45/* "Identifier" */,-51 , 21/* "!" */,-51 , 41/* "String" */,-51 , 42/* "Integer" */,-51 , 43/* "Boolean" */,-51 , 44/* "Float" */,-51 , 35/* ")" */,-51 , 18/* "," */,-51 , 16/* "]" */,-51 ),
    /* State 26 */ new Array( 15/* "[" */,59 , 36/* "->" */,-52 , 34/* "(" */,-52 , 17/* ";" */,-52 , 22/* "==" */,-52 , 29/* "<" */,-52 , 28/* ">" */,-52 , 26/* "<=" */,-52 , 27/* ">=" */,-52 , 23/* "!=" */,-52 , 31/* "-" */,-52 , 30/* "+" */,-52 , 33/* "*" */,-52 , 32/* "/" */,-52 , 19/* "." */,-52 , 7/* "RETURN" */,-52 , 39/* "Variable" */,-52 , 2/* "IF" */,-52 , 4/* "WHILE" */,-52 , 5/* "DO" */,-52 , 6/* "ECHO" */,-52 , 13/* "{" */,-52 , 8/* "NewToken" */,-52 , 45/* "Identifier" */,-52 , 21/* "!" */,-52 , 41/* "String" */,-52 , 42/* "Integer" */,-52 , 43/* "Boolean" */,-52 , 44/* "Float" */,-52 , 35/* ")" */,-52 , 18/* "," */,-52 , 16/* "]" */,-52 ),
    /* State 27 */ new Array( 23/* "!=" */,67 , 27/* ">=" */,68 , 26/* "<=" */,69 , 28/* ">" */,70 , 29/* "<" */,71 , 22/* "==" */,72 , 17/* ";" */,-45 , 19/* "." */,-45 , 7/* "RETURN" */,-45 , 39/* "Variable" */,-45 , 2/* "IF" */,-45 , 4/* "WHILE" */,-45 , 5/* "DO" */,-45 , 6/* "ECHO" */,-45 , 13/* "{" */,-45 , 34/* "(" */,-45 , 8/* "NewToken" */,-45 , 45/* "Identifier" */,-45 , 31/* "-" */,-45 , 21/* "!" */,-45 , 41/* "String" */,-45 , 42/* "Integer" */,-45 , 43/* "Boolean" */,-45 , 44/* "Float" */,-45 , 35/* ")" */,-45 , 18/* "," */,-45 , 30/* "+" */,-45 , 33/* "*" */,-45 , 32/* "/" */,-45 , 16/* "]" */,-45 , 36/* "->" */,-45 ),
    /* State 28 */ new Array( 17/* ";" */,-47 , 19/* "." */,-47 , 7/* "RETURN" */,-47 , 39/* "Variable" */,-47 , 2/* "IF" */,-47 , 4/* "WHILE" */,-47 , 5/* "DO" */,-47 , 6/* "ECHO" */,-47 , 13/* "{" */,-47 , 34/* "(" */,-47 , 8/* "NewToken" */,-47 , 45/* "Identifier" */,-47 , 31/* "-" */,-47 , 21/* "!" */,-47 , 41/* "String" */,-47 , 42/* "Integer" */,-47 , 43/* "Boolean" */,-47 , 44/* "Float" */,-47 , 35/* ")" */,-47 , 18/* "," */,-47 , 22/* "==" */,-47 , 29/* "<" */,-47 , 28/* ">" */,-47 , 26/* "<=" */,-47 , 27/* ">=" */,-47 , 23/* "!=" */,-47 , 30/* "+" */,-47 , 33/* "*" */,-47 , 32/* "/" */,-47 , 16/* "]" */,-47 , 36/* "->" */,-47 ),
    /* State 29 */ new Array( 45/* "Identifier" */,33 , 39/* "Variable" */,78 ),
    /* State 30 */ new Array( 34/* "(" */,30 , 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 31/* "-" */,36 , 21/* "!" */,37 , 45/* "Identifier" */,33 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 31 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 , 35/* ")" */,-66 , 18/* "," */,-66 ),
    /* State 32 */ new Array( 30/* "+" */,85 , 31/* "-" */,86 , 17/* ";" */,-77 , 22/* "==" */,-77 , 29/* "<" */,-77 , 28/* ">" */,-77 , 26/* "<=" */,-77 , 27/* ">=" */,-77 , 23/* "!=" */,-77 , 19/* "." */,-77 , 7/* "RETURN" */,-77 , 39/* "Variable" */,-77 , 2/* "IF" */,-77 , 4/* "WHILE" */,-77 , 5/* "DO" */,-77 , 6/* "ECHO" */,-77 , 13/* "{" */,-77 , 34/* "(" */,-77 , 8/* "NewToken" */,-77 , 45/* "Identifier" */,-77 , 21/* "!" */,-77 , 41/* "String" */,-77 , 42/* "Integer" */,-77 , 43/* "Boolean" */,-77 , 44/* "Float" */,-77 , 35/* ")" */,-77 , 18/* "," */,-77 , 33/* "*" */,-77 , 32/* "/" */,-77 , 16/* "]" */,-77 , 36/* "->" */,-77 ),
    /* State 33 */ new Array( 34/* "(" */,87 ),
    /* State 34 */ new Array( 32/* "/" */,88 , 33/* "*" */,89 , 17/* ";" */,-81 , 22/* "==" */,-81 , 29/* "<" */,-81 , 28/* ">" */,-81 , 26/* "<=" */,-81 , 27/* ">=" */,-81 , 23/* "!=" */,-81 , 31/* "-" */,-81 , 30/* "+" */,-81 , 19/* "." */,-81 , 7/* "RETURN" */,-81 , 39/* "Variable" */,-81 , 2/* "IF" */,-81 , 4/* "WHILE" */,-81 , 5/* "DO" */,-81 , 6/* "ECHO" */,-81 , 13/* "{" */,-81 , 34/* "(" */,-81 , 8/* "NewToken" */,-81 , 45/* "Identifier" */,-81 , 21/* "!" */,-81 , 41/* "String" */,-81 , 42/* "Integer" */,-81 , 43/* "Boolean" */,-81 , 44/* "Float" */,-81 , 35/* ")" */,-81 , 18/* "," */,-81 , 16/* "]" */,-81 , 36/* "->" */,-81 ),
    /* State 35 */ new Array( 17/* ";" */,-85 , 22/* "==" */,-85 , 29/* "<" */,-85 , 28/* ">" */,-85 , 26/* "<=" */,-85 , 27/* ">=" */,-85 , 23/* "!=" */,-85 , 31/* "-" */,-85 , 30/* "+" */,-85 , 33/* "*" */,-85 , 32/* "/" */,-85 , 19/* "." */,-85 , 7/* "RETURN" */,-85 , 39/* "Variable" */,-85 , 2/* "IF" */,-85 , 4/* "WHILE" */,-85 , 5/* "DO" */,-85 , 6/* "ECHO" */,-85 , 13/* "{" */,-85 , 34/* "(" */,-85 , 8/* "NewToken" */,-85 , 45/* "Identifier" */,-85 , 21/* "!" */,-85 , 41/* "String" */,-85 , 42/* "Integer" */,-85 , 43/* "Boolean" */,-85 , 44/* "Float" */,-85 , 35/* ")" */,-85 , 18/* "," */,-85 , 16/* "]" */,-85 , 36/* "->" */,-85 ),
    /* State 36 */ new Array( 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 , 39/* "Variable" */,78 , 45/* "Identifier" */,33 ),
    /* State 37 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 38 */ new Array( 17/* ";" */,-88 , 22/* "==" */,-88 , 29/* "<" */,-88 , 28/* ">" */,-88 , 26/* "<=" */,-88 , 27/* ">=" */,-88 , 23/* "!=" */,-88 , 31/* "-" */,-88 , 30/* "+" */,-88 , 33/* "*" */,-88 , 32/* "/" */,-88 , 19/* "." */,-88 , 7/* "RETURN" */,-88 , 39/* "Variable" */,-88 , 2/* "IF" */,-88 , 4/* "WHILE" */,-88 , 5/* "DO" */,-88 , 6/* "ECHO" */,-88 , 13/* "{" */,-88 , 34/* "(" */,-88 , 8/* "NewToken" */,-88 , 45/* "Identifier" */,-88 , 21/* "!" */,-88 , 41/* "String" */,-88 , 42/* "Integer" */,-88 , 43/* "Boolean" */,-88 , 44/* "Float" */,-88 , 35/* ")" */,-88 , 18/* "," */,-88 , 16/* "]" */,-88 , 36/* "->" */,-88 ),
    /* State 39 */ new Array( 17/* ";" */,-91 , 22/* "==" */,-91 , 29/* "<" */,-91 , 28/* ">" */,-91 , 26/* "<=" */,-91 , 27/* ">=" */,-91 , 23/* "!=" */,-91 , 31/* "-" */,-91 , 30/* "+" */,-91 , 33/* "*" */,-91 , 32/* "/" */,-91 , 19/* "." */,-91 , 7/* "RETURN" */,-91 , 39/* "Variable" */,-91 , 2/* "IF" */,-91 , 4/* "WHILE" */,-91 , 5/* "DO" */,-91 , 6/* "ECHO" */,-91 , 13/* "{" */,-91 , 34/* "(" */,-91 , 8/* "NewToken" */,-91 , 45/* "Identifier" */,-91 , 21/* "!" */,-91 , 41/* "String" */,-91 , 42/* "Integer" */,-91 , 43/* "Boolean" */,-91 , 44/* "Float" */,-91 , 35/* ")" */,-91 , 18/* "," */,-91 , 16/* "]" */,-91 , 36/* "->" */,-91 ),
    /* State 40 */ new Array( 17/* ";" */,-92 , 22/* "==" */,-92 , 29/* "<" */,-92 , 28/* ">" */,-92 , 26/* "<=" */,-92 , 27/* ">=" */,-92 , 23/* "!=" */,-92 , 31/* "-" */,-92 , 30/* "+" */,-92 , 33/* "*" */,-92 , 32/* "/" */,-92 , 19/* "." */,-92 , 7/* "RETURN" */,-92 , 39/* "Variable" */,-92 , 2/* "IF" */,-92 , 4/* "WHILE" */,-92 , 5/* "DO" */,-92 , 6/* "ECHO" */,-92 , 13/* "{" */,-92 , 34/* "(" */,-92 , 8/* "NewToken" */,-92 , 45/* "Identifier" */,-92 , 21/* "!" */,-92 , 41/* "String" */,-92 , 42/* "Integer" */,-92 , 43/* "Boolean" */,-92 , 44/* "Float" */,-92 , 35/* ")" */,-92 , 18/* "," */,-92 , 16/* "]" */,-92 , 36/* "->" */,-92 ),
    /* State 41 */ new Array( 17/* ";" */,-93 , 22/* "==" */,-93 , 29/* "<" */,-93 , 28/* ">" */,-93 , 26/* "<=" */,-93 , 27/* ">=" */,-93 , 23/* "!=" */,-93 , 31/* "-" */,-93 , 30/* "+" */,-93 , 33/* "*" */,-93 , 32/* "/" */,-93 , 19/* "." */,-93 , 7/* "RETURN" */,-93 , 39/* "Variable" */,-93 , 2/* "IF" */,-93 , 4/* "WHILE" */,-93 , 5/* "DO" */,-93 , 6/* "ECHO" */,-93 , 13/* "{" */,-93 , 34/* "(" */,-93 , 8/* "NewToken" */,-93 , 45/* "Identifier" */,-93 , 21/* "!" */,-93 , 41/* "String" */,-93 , 42/* "Integer" */,-93 , 43/* "Boolean" */,-93 , 44/* "Float" */,-93 , 35/* ")" */,-93 , 18/* "," */,-93 , 16/* "]" */,-93 , 36/* "->" */,-93 ),
    /* State 42 */ new Array( 17/* ";" */,-94 , 22/* "==" */,-94 , 29/* "<" */,-94 , 28/* ">" */,-94 , 26/* "<=" */,-94 , 27/* ">=" */,-94 , 23/* "!=" */,-94 , 31/* "-" */,-94 , 30/* "+" */,-94 , 33/* "*" */,-94 , 32/* "/" */,-94 , 19/* "." */,-94 , 7/* "RETURN" */,-94 , 39/* "Variable" */,-94 , 2/* "IF" */,-94 , 4/* "WHILE" */,-94 , 5/* "DO" */,-94 , 6/* "ECHO" */,-94 , 13/* "{" */,-94 , 34/* "(" */,-94 , 8/* "NewToken" */,-94 , 45/* "Identifier" */,-94 , 21/* "!" */,-94 , 41/* "String" */,-94 , 42/* "Integer" */,-94 , 43/* "Boolean" */,-94 , 44/* "Float" */,-94 , 35/* ")" */,-94 , 18/* "," */,-94 , 16/* "]" */,-94 , 36/* "->" */,-94 ),
    /* State 43 */ new Array( 48/* "InternalNonScript" */,8 , 38/* "//" */,9 , 2/* "IF" */,13 , 4/* "WHILE" */,14 , 5/* "DO" */,15 , 6/* "ECHO" */,16 , 39/* "Variable" */,17 , 13/* "{" */,18 , 9/* "ClassToken" */,19 , 40/* "FunctionName" */,20 , 7/* "RETURN" */,21 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 , 47/* "ScriptEnd" */,-29 , 14/* "}" */,-29 ),
    /* State 44 */ new Array( 79/* "$" */,-3 , 46/* "ScriptBegin" */,-3 ),
    /* State 45 */ new Array( 47/* "ScriptEnd" */,-34 , 48/* "InternalNonScript" */,-34 , 38/* "//" */,-34 , 7/* "RETURN" */,-34 , 39/* "Variable" */,-34 , 2/* "IF" */,-34 , 4/* "WHILE" */,-34 , 5/* "DO" */,-34 , 6/* "ECHO" */,-34 , 13/* "{" */,-34 , 9/* "ClassToken" */,-34 , 40/* "FunctionName" */,-34 , 34/* "(" */,-34 , 8/* "NewToken" */,-34 , 45/* "Identifier" */,-34 , 31/* "-" */,-34 , 21/* "!" */,-34 , 41/* "String" */,-34 , 42/* "Integer" */,-34 , 43/* "Boolean" */,-34 , 44/* "Float" */,-34 , 14/* "}" */,-34 ),
    /* State 46 */ new Array( 41/* "String" */,93 , 47/* "ScriptEnd" */,-38 , 48/* "InternalNonScript" */,-38 , 38/* "//" */,-38 , 7/* "RETURN" */,-38 , 39/* "Variable" */,-38 , 2/* "IF" */,-38 , 4/* "WHILE" */,-38 , 5/* "DO" */,-38 , 6/* "ECHO" */,-38 , 13/* "{" */,-38 , 9/* "ClassToken" */,-38 , 40/* "FunctionName" */,-38 , 34/* "(" */,-38 , 8/* "NewToken" */,-38 , 45/* "Identifier" */,-38 , 31/* "-" */,-38 , 21/* "!" */,-38 , 42/* "Integer" */,-38 , 43/* "Boolean" */,-38 , 44/* "Float" */,-38 , 14/* "}" */,-38 ),
    /* State 47 */ new Array( 47/* "ScriptEnd" */,-19 , 48/* "InternalNonScript" */,-19 , 38/* "//" */,-19 , 7/* "RETURN" */,-19 , 39/* "Variable" */,-19 , 2/* "IF" */,-19 , 4/* "WHILE" */,-19 , 5/* "DO" */,-19 , 6/* "ECHO" */,-19 , 13/* "{" */,-19 , 9/* "ClassToken" */,-19 , 40/* "FunctionName" */,-19 , 34/* "(" */,-19 , 8/* "NewToken" */,-19 , 45/* "Identifier" */,-19 , 31/* "-" */,-19 , 21/* "!" */,-19 , 41/* "String" */,-19 , 42/* "Integer" */,-19 , 43/* "Boolean" */,-19 , 44/* "Float" */,-19 , 14/* "}" */,-19 , 3/* "ELSE" */,-19 ),
    /* State 48 */ new Array( 47/* "ScriptEnd" */,-20 , 48/* "InternalNonScript" */,-20 , 38/* "//" */,-20 , 7/* "RETURN" */,-20 , 39/* "Variable" */,-20 , 2/* "IF" */,-20 , 4/* "WHILE" */,-20 , 5/* "DO" */,-20 , 6/* "ECHO" */,-20 , 13/* "{" */,-20 , 9/* "ClassToken" */,-20 , 40/* "FunctionName" */,-20 , 34/* "(" */,-20 , 8/* "NewToken" */,-20 , 45/* "Identifier" */,-20 , 31/* "-" */,-20 , 21/* "!" */,-20 , 41/* "String" */,-20 , 42/* "Integer" */,-20 , 43/* "Boolean" */,-20 , 44/* "Float" */,-20 , 14/* "}" */,-20 , 3/* "ELSE" */,-20 ),
    /* State 49 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 50 */ new Array( 47/* "ScriptEnd" */,-21 , 48/* "InternalNonScript" */,-21 , 38/* "//" */,-21 , 7/* "RETURN" */,-21 , 39/* "Variable" */,-21 , 2/* "IF" */,-21 , 4/* "WHILE" */,-21 , 5/* "DO" */,-21 , 6/* "ECHO" */,-21 , 13/* "{" */,-21 , 9/* "ClassToken" */,-21 , 40/* "FunctionName" */,-21 , 34/* "(" */,-21 , 8/* "NewToken" */,-21 , 45/* "Identifier" */,-21 , 31/* "-" */,-21 , 21/* "!" */,-21 , 41/* "String" */,-21 , 42/* "Integer" */,-21 , 43/* "Boolean" */,-21 , 44/* "Float" */,-21 , 14/* "}" */,-21 , 3/* "ELSE" */,-21 ),
    /* State 51 */ new Array( 19/* "." */,49 , 2/* "IF" */,13 , 4/* "WHILE" */,14 , 5/* "DO" */,15 , 6/* "ECHO" */,16 , 39/* "Variable" */,17 , 13/* "{" */,18 , 7/* "RETURN" */,21 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 52 */ new Array( 7/* "RETURN" */,-46 , 39/* "Variable" */,-46 , 2/* "IF" */,-46 , 4/* "WHILE" */,-46 , 5/* "DO" */,-46 , 6/* "ECHO" */,-46 , 13/* "{" */,-46 , 34/* "(" */,-46 , 8/* "NewToken" */,-46 , 45/* "Identifier" */,-46 , 31/* "-" */,-46 , 21/* "!" */,-46 , 41/* "String" */,-46 , 42/* "Integer" */,-46 , 43/* "Boolean" */,-46 , 44/* "Float" */,-46 , 19/* "." */,-46 , 17/* ";" */,-46 , 35/* ")" */,-46 , 18/* "," */,-46 , 22/* "==" */,-46 , 29/* "<" */,-46 , 28/* ">" */,-46 , 26/* "<=" */,-46 , 27/* ">=" */,-46 , 23/* "!=" */,-46 , 30/* "+" */,-46 , 33/* "*" */,-46 , 32/* "/" */,-46 , 16/* "]" */,-46 , 36/* "->" */,-46 ),
    /* State 53 */ new Array( 20/* "=" */,58 , 15/* "[" */,59 , 36/* "->" */,-89 , 7/* "RETURN" */,-89 , 39/* "Variable" */,-89 , 2/* "IF" */,-89 , 4/* "WHILE" */,-89 , 5/* "DO" */,-89 , 6/* "ECHO" */,-89 , 13/* "{" */,-89 , 34/* "(" */,-89 , 8/* "NewToken" */,-89 , 45/* "Identifier" */,-89 , 31/* "-" */,-89 , 21/* "!" */,-89 , 41/* "String" */,-89 , 42/* "Integer" */,-89 , 43/* "Boolean" */,-89 , 44/* "Float" */,-89 , 22/* "==" */,-89 , 29/* "<" */,-89 , 28/* ">" */,-89 , 26/* "<=" */,-89 , 27/* ">=" */,-89 , 23/* "!=" */,-89 , 30/* "+" */,-89 , 33/* "*" */,-89 , 32/* "/" */,-89 , 19/* "." */,-89 , 17/* ";" */,-89 , 35/* ")" */,-89 , 18/* "," */,-89 , 16/* "]" */,-89 ),
    /* State 54 */ new Array( 19/* "." */,49 , 2/* "IF" */,13 , 4/* "WHILE" */,14 , 5/* "DO" */,15 , 6/* "ECHO" */,16 , 39/* "Variable" */,17 , 13/* "{" */,18 , 7/* "RETURN" */,21 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 55 */ new Array( 4/* "WHILE" */,98 ),
    /* State 56 */ new Array( 19/* "." */,49 , 17/* ";" */,99 ),
    /* State 57 */ new Array( 15/* "[" */,100 , 20/* "=" */,101 , 17/* ";" */,-48 , 19/* "." */,-48 ),
    /* State 58 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 59 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 60 */ new Array( 14/* "}" */,104 , 48/* "InternalNonScript" */,8 , 38/* "//" */,9 , 2/* "IF" */,13 , 4/* "WHILE" */,14 , 5/* "DO" */,15 , 6/* "ECHO" */,16 , 39/* "Variable" */,17 , 13/* "{" */,18 , 9/* "ClassToken" */,19 , 40/* "FunctionName" */,20 , 7/* "RETURN" */,21 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 61 */ new Array( 13/* "{" */,105 ),
    /* State 62 */ new Array( 39/* "Variable" */,107 , 35/* ")" */,-42 , 18/* "," */,-42 ),
    /* State 63 */ new Array( 19/* "." */,49 , 17/* ";" */,-43 ),
    /* State 64 */ new Array( 18/* "," */,-57 , 34/* "(" */,-57 , 39/* "Variable" */,-57 , 8/* "NewToken" */,-57 , 45/* "Identifier" */,-57 , 31/* "-" */,-57 , 21/* "!" */,-57 , 41/* "String" */,-57 , 42/* "Integer" */,-57 , 43/* "Boolean" */,-57 , 44/* "Float" */,-57 , 35/* ")" */,-57 , 19/* "." */,-57 , 36/* "->" */,-57 , 17/* ";" */,-57 , 22/* "==" */,-57 , 29/* "<" */,-57 , 28/* ">" */,-57 , 26/* "<=" */,-57 , 27/* ">=" */,-57 , 23/* "!=" */,-57 , 30/* "+" */,-57 , 33/* "*" */,-57 , 32/* "/" */,-57 , 7/* "RETURN" */,-57 , 2/* "IF" */,-57 , 4/* "WHILE" */,-57 , 5/* "DO" */,-57 , 6/* "ECHO" */,-57 , 13/* "{" */,-57 , 16/* "]" */,-57 ),
    /* State 65 */ new Array( 45/* "Identifier" */,110 , 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 66 */ new Array( 15/* "[" */,100 , 36/* "->" */,-53 , 34/* "(" */,-53 , 17/* ";" */,-53 , 22/* "==" */,-53 , 29/* "<" */,-53 , 28/* ">" */,-53 , 26/* "<=" */,-53 , 27/* ">=" */,-53 , 23/* "!=" */,-53 , 31/* "-" */,-53 , 30/* "+" */,-53 , 33/* "*" */,-53 , 32/* "/" */,-53 , 19/* "." */,-53 , 7/* "RETURN" */,-53 , 39/* "Variable" */,-53 , 2/* "IF" */,-53 , 4/* "WHILE" */,-53 , 5/* "DO" */,-53 , 6/* "ECHO" */,-53 , 13/* "{" */,-53 , 8/* "NewToken" */,-53 , 45/* "Identifier" */,-53 , 21/* "!" */,-53 , 41/* "String" */,-53 , 42/* "Integer" */,-53 , 43/* "Boolean" */,-53 , 44/* "Float" */,-53 , 35/* ")" */,-53 , 18/* "," */,-53 , 16/* "]" */,-53 ),
    /* State 67 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 68 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 69 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 70 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 71 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 72 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 73 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 , 35/* ")" */,-66 , 18/* "," */,-66 ),
    /* State 74 */ new Array( 36/* "->" */,120 , 34/* "(" */,64 ),
    /* State 75 */ new Array( 15/* "[" */,59 , 34/* "(" */,-52 , 36/* "->" */,-52 ),
    /* State 76 */ new Array( 34/* "(" */,-58 , 36/* "->" */,-58 , 17/* ";" */,-58 , 22/* "==" */,-58 , 29/* "<" */,-58 , 28/* ">" */,-58 , 26/* "<=" */,-58 , 27/* ">=" */,-58 , 23/* "!=" */,-58 , 31/* "-" */,-58 , 30/* "+" */,-58 , 33/* "*" */,-58 , 32/* "/" */,-58 , 19/* "." */,-58 , 7/* "RETURN" */,-58 , 39/* "Variable" */,-58 , 2/* "IF" */,-58 , 4/* "WHILE" */,-58 , 5/* "DO" */,-58 , 6/* "ECHO" */,-58 , 13/* "{" */,-58 , 8/* "NewToken" */,-58 , 45/* "Identifier" */,-58 , 21/* "!" */,-58 , 41/* "String" */,-58 , 42/* "Integer" */,-58 , 43/* "Boolean" */,-58 , 44/* "Float" */,-58 , 35/* ")" */,-58 , 18/* "," */,-58 , 16/* "]" */,-58 ),
    /* State 77 */ new Array( 34/* "(" */,-59 , 36/* "->" */,-59 , 17/* ";" */,-59 , 22/* "==" */,-59 , 29/* "<" */,-59 , 28/* ">" */,-59 , 26/* "<=" */,-59 , 27/* ">=" */,-59 , 23/* "!=" */,-59 , 31/* "-" */,-59 , 30/* "+" */,-59 , 33/* "*" */,-59 , 32/* "/" */,-59 , 19/* "." */,-59 , 7/* "RETURN" */,-59 , 39/* "Variable" */,-59 , 2/* "IF" */,-59 , 4/* "WHILE" */,-59 , 5/* "DO" */,-59 , 6/* "ECHO" */,-59 , 13/* "{" */,-59 , 8/* "NewToken" */,-59 , 45/* "Identifier" */,-59 , 21/* "!" */,-59 , 41/* "String" */,-59 , 42/* "Integer" */,-59 , 43/* "Boolean" */,-59 , 44/* "Float" */,-59 , 35/* ")" */,-59 , 18/* "," */,-59 , 16/* "]" */,-59 ),
    /* State 78 */ new Array( 34/* "(" */,-89 , 15/* "[" */,-89 , 36/* "->" */,-89 , 17/* ";" */,-89 , 22/* "==" */,-89 , 29/* "<" */,-89 , 28/* ">" */,-89 , 26/* "<=" */,-89 , 27/* ">=" */,-89 , 23/* "!=" */,-89 , 31/* "-" */,-89 , 30/* "+" */,-89 , 33/* "*" */,-89 , 32/* "/" */,-89 , 19/* "." */,-89 , 7/* "RETURN" */,-89 , 39/* "Variable" */,-89 , 2/* "IF" */,-89 , 4/* "WHILE" */,-89 , 5/* "DO" */,-89 , 6/* "ECHO" */,-89 , 13/* "{" */,-89 , 8/* "NewToken" */,-89 , 45/* "Identifier" */,-89 , 21/* "!" */,-89 , 41/* "String" */,-89 , 42/* "Integer" */,-89 , 43/* "Boolean" */,-89 , 44/* "Float" */,-89 , 35/* ")" */,-89 , 18/* "," */,-89 , 16/* "]" */,-89 ),
    /* State 79 */ new Array( 32/* "/" */,88 , 33/* "*" */,89 , 35/* ")" */,121 , 22/* "==" */,-81 , 29/* "<" */,-81 , 28/* ">" */,-81 , 26/* "<=" */,-81 , 27/* ">=" */,-81 , 23/* "!=" */,-81 , 31/* "-" */,-81 , 30/* "+" */,-81 , 19/* "." */,-81 ),
    /* State 80 */ new Array( 30/* "+" */,85 , 31/* "-" */,86 , 35/* ")" */,122 , 22/* "==" */,-77 , 29/* "<" */,-77 , 28/* ">" */,-77 , 26/* "<=" */,-77 , 27/* ">=" */,-77 , 23/* "!=" */,-77 , 19/* "." */,-77 ),
    /* State 81 */ new Array( 23/* "!=" */,67 , 27/* ">=" */,68 , 26/* "<=" */,69 , 28/* ">" */,70 , 29/* "<" */,71 , 22/* "==" */,72 , 35/* ")" */,123 , 19/* "." */,-45 ),
    /* State 82 */ new Array( 19/* "." */,49 , 35/* ")" */,124 ),
    /* State 83 */ new Array( 18/* "," */,125 , 35/* ")" */,126 ),
    /* State 84 */ new Array( 19/* "." */,49 , 35/* ")" */,-65 , 18/* "," */,-65 ),
    /* State 85 */ new Array( 34/* "(" */,128 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 , 39/* "Variable" */,78 , 45/* "Identifier" */,33 ),
    /* State 86 */ new Array( 34/* "(" */,128 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 , 39/* "Variable" */,78 , 45/* "Identifier" */,33 ),
    /* State 87 */ new Array( 18/* "," */,-56 , 34/* "(" */,-56 , 39/* "Variable" */,-56 , 8/* "NewToken" */,-56 , 45/* "Identifier" */,-56 , 31/* "-" */,-56 , 21/* "!" */,-56 , 41/* "String" */,-56 , 42/* "Integer" */,-56 , 43/* "Boolean" */,-56 , 44/* "Float" */,-56 , 35/* ")" */,-56 ),
    /* State 88 */ new Array( 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 , 39/* "Variable" */,78 , 45/* "Identifier" */,33 ),
    /* State 89 */ new Array( 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 , 39/* "Variable" */,78 , 45/* "Identifier" */,33 ),
    /* State 90 */ new Array( 17/* ";" */,-86 , 22/* "==" */,-86 , 29/* "<" */,-86 , 28/* ">" */,-86 , 26/* "<=" */,-86 , 27/* ">=" */,-86 , 23/* "!=" */,-86 , 31/* "-" */,-86 , 30/* "+" */,-86 , 33/* "*" */,-86 , 32/* "/" */,-86 , 19/* "." */,-86 , 7/* "RETURN" */,-86 , 39/* "Variable" */,-86 , 2/* "IF" */,-86 , 4/* "WHILE" */,-86 , 5/* "DO" */,-86 , 6/* "ECHO" */,-86 , 13/* "{" */,-86 , 34/* "(" */,-86 , 8/* "NewToken" */,-86 , 45/* "Identifier" */,-86 , 21/* "!" */,-86 , 41/* "String" */,-86 , 42/* "Integer" */,-86 , 43/* "Boolean" */,-86 , 44/* "Float" */,-86 , 35/* ")" */,-86 , 18/* "," */,-86 , 16/* "]" */,-86 , 36/* "->" */,-86 ),
    /* State 91 */ new Array( 34/* "(" */,64 , 36/* "->" */,120 , 17/* ";" */,-95 , 22/* "==" */,-95 , 29/* "<" */,-95 , 28/* ">" */,-95 , 26/* "<=" */,-95 , 27/* ">=" */,-95 , 23/* "!=" */,-95 , 31/* "-" */,-95 , 30/* "+" */,-95 , 33/* "*" */,-95 , 32/* "/" */,-95 , 19/* "." */,-95 , 7/* "RETURN" */,-95 , 39/* "Variable" */,-95 , 2/* "IF" */,-95 , 4/* "WHILE" */,-95 , 5/* "DO" */,-95 , 6/* "ECHO" */,-95 , 13/* "{" */,-95 , 8/* "NewToken" */,-95 , 45/* "Identifier" */,-95 , 21/* "!" */,-95 , 41/* "String" */,-95 , 42/* "Integer" */,-95 , 43/* "Boolean" */,-95 , 44/* "Float" */,-95 , 35/* ")" */,-95 , 18/* "," */,-95 , 16/* "]" */,-95 ),
    /* State 92 */ new Array( 19/* "." */,49 , 17/* ";" */,-87 , 22/* "==" */,-87 , 29/* "<" */,-87 , 28/* ">" */,-87 , 26/* "<=" */,-87 , 27/* ">=" */,-87 , 23/* "!=" */,-87 , 31/* "-" */,-87 , 30/* "+" */,-87 , 33/* "*" */,-87 , 32/* "/" */,-87 , 7/* "RETURN" */,-87 , 39/* "Variable" */,-87 , 2/* "IF" */,-87 , 4/* "WHILE" */,-87 , 5/* "DO" */,-87 , 6/* "ECHO" */,-87 , 13/* "{" */,-87 , 34/* "(" */,-87 , 8/* "NewToken" */,-87 , 45/* "Identifier" */,-87 , 21/* "!" */,-87 , 41/* "String" */,-87 , 42/* "Integer" */,-87 , 43/* "Boolean" */,-87 , 44/* "Float" */,-87 , 35/* ")" */,-87 , 18/* "," */,-87 , 16/* "]" */,-87 , 36/* "->" */,-87 ),
    /* State 93 */ new Array( 47/* "ScriptEnd" */,-37 , 48/* "InternalNonScript" */,-37 , 38/* "//" */,-37 , 7/* "RETURN" */,-37 , 39/* "Variable" */,-37 , 2/* "IF" */,-37 , 4/* "WHILE" */,-37 , 5/* "DO" */,-37 , 6/* "ECHO" */,-37 , 13/* "{" */,-37 , 9/* "ClassToken" */,-37 , 40/* "FunctionName" */,-37 , 34/* "(" */,-37 , 8/* "NewToken" */,-37 , 45/* "Identifier" */,-37 , 31/* "-" */,-37 , 21/* "!" */,-37 , 41/* "String" */,-37 , 42/* "Integer" */,-37 , 43/* "Boolean" */,-37 , 44/* "Float" */,-37 , 14/* "}" */,-37 ),
    /* State 94 */ new Array( 19/* "." */,49 , 17/* ";" */,-75 , 22/* "==" */,-75 , 29/* "<" */,-75 , 28/* ">" */,-75 , 26/* "<=" */,-75 , 27/* ">=" */,-75 , 23/* "!=" */,-75 , 7/* "RETURN" */,-75 , 39/* "Variable" */,-75 , 2/* "IF" */,-75 , 4/* "WHILE" */,-75 , 5/* "DO" */,-75 , 6/* "ECHO" */,-75 , 13/* "{" */,-75 , 34/* "(" */,-75 , 8/* "NewToken" */,-75 , 45/* "Identifier" */,-75 , 31/* "-" */,-75 , 21/* "!" */,-75 , 41/* "String" */,-75 , 42/* "Integer" */,-75 , 43/* "Boolean" */,-75 , 44/* "Float" */,-75 , 35/* ")" */,-75 , 18/* "," */,-75 , 30/* "+" */,-75 , 33/* "*" */,-75 , 32/* "/" */,-75 , 16/* "]" */,-75 , 36/* "->" */,-75 ),
    /* State 95 */ new Array( 3/* "ELSE" */,132 , 47/* "ScriptEnd" */,-22 , 48/* "InternalNonScript" */,-22 , 38/* "//" */,-22 , 7/* "RETURN" */,-22 , 39/* "Variable" */,-22 , 2/* "IF" */,-22 , 4/* "WHILE" */,-22 , 5/* "DO" */,-22 , 6/* "ECHO" */,-22 , 13/* "{" */,-22 , 9/* "ClassToken" */,-22 , 40/* "FunctionName" */,-22 , 34/* "(" */,-22 , 8/* "NewToken" */,-22 , 45/* "Identifier" */,-22 , 31/* "-" */,-22 , 21/* "!" */,-22 , 41/* "String" */,-22 , 42/* "Integer" */,-22 , 43/* "Boolean" */,-22 , 44/* "Float" */,-22 , 14/* "}" */,-22 ),
    /* State 96 */ new Array( 15/* "[" */,100 , 7/* "RETURN" */,-48 , 39/* "Variable" */,-48 , 2/* "IF" */,-48 , 4/* "WHILE" */,-48 , 5/* "DO" */,-48 , 6/* "ECHO" */,-48 , 13/* "{" */,-48 , 34/* "(" */,-48 , 8/* "NewToken" */,-48 , 45/* "Identifier" */,-48 , 31/* "-" */,-48 , 21/* "!" */,-48 , 41/* "String" */,-48 , 42/* "Integer" */,-48 , 43/* "Boolean" */,-48 , 44/* "Float" */,-48 , 19/* "." */,-48 , 17/* ";" */,-48 , 35/* ")" */,-48 , 18/* "," */,-48 , 22/* "==" */,-48 , 29/* "<" */,-48 , 28/* ">" */,-48 , 26/* "<=" */,-48 , 27/* ">=" */,-48 , 23/* "!=" */,-48 , 30/* "+" */,-48 , 33/* "*" */,-48 , 32/* "/" */,-48 , 16/* "]" */,-48 , 36/* "->" */,-48 ),
    /* State 97 */ new Array( 47/* "ScriptEnd" */,-24 , 48/* "InternalNonScript" */,-24 , 38/* "//" */,-24 , 7/* "RETURN" */,-24 , 39/* "Variable" */,-24 , 2/* "IF" */,-24 , 4/* "WHILE" */,-24 , 5/* "DO" */,-24 , 6/* "ECHO" */,-24 , 13/* "{" */,-24 , 9/* "ClassToken" */,-24 , 40/* "FunctionName" */,-24 , 34/* "(" */,-24 , 8/* "NewToken" */,-24 , 45/* "Identifier" */,-24 , 31/* "-" */,-24 , 21/* "!" */,-24 , 41/* "String" */,-24 , 42/* "Integer" */,-24 , 43/* "Boolean" */,-24 , 44/* "Float" */,-24 , 14/* "}" */,-24 , 3/* "ELSE" */,-24 ),
    /* State 98 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 99 */ new Array( 47/* "ScriptEnd" */,-26 , 48/* "InternalNonScript" */,-26 , 38/* "//" */,-26 , 7/* "RETURN" */,-26 , 39/* "Variable" */,-26 , 2/* "IF" */,-26 , 4/* "WHILE" */,-26 , 5/* "DO" */,-26 , 6/* "ECHO" */,-26 , 13/* "{" */,-26 , 9/* "ClassToken" */,-26 , 40/* "FunctionName" */,-26 , 34/* "(" */,-26 , 8/* "NewToken" */,-26 , 45/* "Identifier" */,-26 , 31/* "-" */,-26 , 21/* "!" */,-26 , 41/* "String" */,-26 , 42/* "Integer" */,-26 , 43/* "Boolean" */,-26 , 44/* "Float" */,-26 , 14/* "}" */,-26 , 3/* "ELSE" */,-26 ),
    /* State 100 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 101 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 102 */ new Array( 19/* "." */,49 , 17/* ";" */,-35 , 7/* "RETURN" */,-35 , 39/* "Variable" */,-35 , 2/* "IF" */,-35 , 4/* "WHILE" */,-35 , 5/* "DO" */,-35 , 6/* "ECHO" */,-35 , 13/* "{" */,-35 , 34/* "(" */,-35 , 8/* "NewToken" */,-35 , 45/* "Identifier" */,-35 , 31/* "-" */,-35 , 21/* "!" */,-35 , 41/* "String" */,-35 , 42/* "Integer" */,-35 , 43/* "Boolean" */,-35 , 44/* "Float" */,-35 , 35/* ")" */,-35 , 18/* "," */,-35 , 22/* "==" */,-35 , 29/* "<" */,-35 , 28/* ">" */,-35 , 26/* "<=" */,-35 , 27/* ">=" */,-35 , 23/* "!=" */,-35 , 30/* "+" */,-35 , 33/* "*" */,-35 , 32/* "/" */,-35 , 16/* "]" */,-35 , 36/* "->" */,-35 ),
    /* State 103 */ new Array( 19/* "." */,49 , 16/* "]" */,136 ),
    /* State 104 */ new Array( 47/* "ScriptEnd" */,-28 , 48/* "InternalNonScript" */,-28 , 38/* "//" */,-28 , 7/* "RETURN" */,-28 , 39/* "Variable" */,-28 , 2/* "IF" */,-28 , 4/* "WHILE" */,-28 , 5/* "DO" */,-28 , 6/* "ECHO" */,-28 , 13/* "{" */,-28 , 9/* "ClassToken" */,-28 , 40/* "FunctionName" */,-28 , 34/* "(" */,-28 , 8/* "NewToken" */,-28 , 45/* "Identifier" */,-28 , 31/* "-" */,-28 , 21/* "!" */,-28 , 41/* "String" */,-28 , 42/* "Integer" */,-28 , 43/* "Boolean" */,-28 , 44/* "Float" */,-28 , 14/* "}" */,-28 , 3/* "ELSE" */,-28 ),
    /* State 105 */ new Array( 14/* "}" */,-7 , 10/* "PublicToken" */,-7 , 12/* "ProtectedToken" */,-7 , 11/* "PrivateToken" */,-7 , 40/* "FunctionName" */,-7 ),
    /* State 106 */ new Array( 18/* "," */,138 , 35/* ")" */,139 ),
    /* State 107 */ new Array( 35/* ")" */,-41 , 18/* "," */,-41 ),
    /* State 108 */ new Array( 20/* "=" */,140 , 17/* ";" */,-47 , 36/* "->" */,-47 , 19/* "." */,-47 , 34/* "(" */,-47 , 22/* "==" */,-47 , 29/* "<" */,-47 , 28/* ">" */,-47 , 26/* "<=" */,-47 , 27/* ">=" */,-47 , 23/* "!=" */,-47 , 31/* "-" */,-47 , 30/* "+" */,-47 , 33/* "*" */,-47 , 32/* "/" */,-47 , 7/* "RETURN" */,-47 , 39/* "Variable" */,-47 , 2/* "IF" */,-47 , 4/* "WHILE" */,-47 , 5/* "DO" */,-47 , 6/* "ECHO" */,-47 , 13/* "{" */,-47 , 8/* "NewToken" */,-47 , 45/* "Identifier" */,-47 , 21/* "!" */,-47 , 41/* "String" */,-47 , 42/* "Integer" */,-47 , 43/* "Boolean" */,-47 , 44/* "Float" */,-47 , 35/* ")" */,-47 , 18/* "," */,-47 , 16/* "]" */,-47 ),
    /* State 109 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 , 35/* ")" */,-66 , 18/* "," */,-66 ),
    /* State 110 */ new Array( 34/* "(" */,87 , 17/* ";" */,-60 , 36/* "->" */,-60 , 19/* "." */,-60 , 22/* "==" */,-60 , 29/* "<" */,-60 , 28/* ">" */,-60 , 26/* "<=" */,-60 , 27/* ">=" */,-60 , 23/* "!=" */,-60 , 31/* "-" */,-60 , 30/* "+" */,-60 , 33/* "*" */,-60 , 32/* "/" */,-60 , 7/* "RETURN" */,-60 , 39/* "Variable" */,-60 , 2/* "IF" */,-60 , 4/* "WHILE" */,-60 , 5/* "DO" */,-60 , 6/* "ECHO" */,-60 , 13/* "{" */,-60 , 8/* "NewToken" */,-60 , 45/* "Identifier" */,-60 , 21/* "!" */,-60 , 41/* "String" */,-60 , 42/* "Integer" */,-60 , 43/* "Boolean" */,-60 , 44/* "Float" */,-60 , 35/* ")" */,-60 , 18/* "," */,-60 , 16/* "]" */,-60 , 20/* "=" */,-60 ),
    /* State 111 */ new Array( 17/* ";" */,-61 , 36/* "->" */,-61 , 19/* "." */,-54 , 34/* "(" */,-61 , 22/* "==" */,-61 , 29/* "<" */,-61 , 28/* ">" */,-61 , 26/* "<=" */,-61 , 27/* ">=" */,-61 , 23/* "!=" */,-61 , 31/* "-" */,-61 , 30/* "+" */,-61 , 33/* "*" */,-61 , 32/* "/" */,-61 , 7/* "RETURN" */,-61 , 39/* "Variable" */,-61 , 2/* "IF" */,-61 , 4/* "WHILE" */,-61 , 5/* "DO" */,-61 , 6/* "ECHO" */,-61 , 13/* "{" */,-61 , 8/* "NewToken" */,-61 , 45/* "Identifier" */,-61 , 21/* "!" */,-61 , 41/* "String" */,-61 , 42/* "Integer" */,-61 , 43/* "Boolean" */,-61 , 44/* "Float" */,-61 , 35/* ")" */,-61 , 18/* "," */,-61 , 16/* "]" */,-61 ),
    /* State 112 */ new Array( 19/* "." */,49 ),
    /* State 113 */ new Array( 19/* "." */,49 , 17/* ";" */,-74 , 22/* "==" */,-74 , 29/* "<" */,-74 , 28/* ">" */,-74 , 26/* "<=" */,-74 , 27/* ">=" */,-74 , 23/* "!=" */,-74 , 7/* "RETURN" */,-74 , 39/* "Variable" */,-74 , 2/* "IF" */,-74 , 4/* "WHILE" */,-74 , 5/* "DO" */,-74 , 6/* "ECHO" */,-74 , 13/* "{" */,-74 , 34/* "(" */,-74 , 8/* "NewToken" */,-74 , 45/* "Identifier" */,-74 , 31/* "-" */,-74 , 21/* "!" */,-74 , 41/* "String" */,-74 , 42/* "Integer" */,-74 , 43/* "Boolean" */,-74 , 44/* "Float" */,-74 , 35/* ")" */,-74 , 18/* "," */,-74 , 30/* "+" */,-74 , 33/* "*" */,-74 , 32/* "/" */,-74 , 16/* "]" */,-74 , 36/* "->" */,-74 ),
    /* State 114 */ new Array( 19/* "." */,49 , 17/* ";" */,-73 , 22/* "==" */,-73 , 29/* "<" */,-73 , 28/* ">" */,-73 , 26/* "<=" */,-73 , 27/* ">=" */,-73 , 23/* "!=" */,-73 , 7/* "RETURN" */,-73 , 39/* "Variable" */,-73 , 2/* "IF" */,-73 , 4/* "WHILE" */,-73 , 5/* "DO" */,-73 , 6/* "ECHO" */,-73 , 13/* "{" */,-73 , 34/* "(" */,-73 , 8/* "NewToken" */,-73 , 45/* "Identifier" */,-73 , 31/* "-" */,-73 , 21/* "!" */,-73 , 41/* "String" */,-73 , 42/* "Integer" */,-73 , 43/* "Boolean" */,-73 , 44/* "Float" */,-73 , 35/* ")" */,-73 , 18/* "," */,-73 , 30/* "+" */,-73 , 33/* "*" */,-73 , 32/* "/" */,-73 , 16/* "]" */,-73 , 36/* "->" */,-73 ),
    /* State 115 */ new Array( 19/* "." */,49 , 17/* ";" */,-72 , 22/* "==" */,-72 , 29/* "<" */,-72 , 28/* ">" */,-72 , 26/* "<=" */,-72 , 27/* ">=" */,-72 , 23/* "!=" */,-72 , 7/* "RETURN" */,-72 , 39/* "Variable" */,-72 , 2/* "IF" */,-72 , 4/* "WHILE" */,-72 , 5/* "DO" */,-72 , 6/* "ECHO" */,-72 , 13/* "{" */,-72 , 34/* "(" */,-72 , 8/* "NewToken" */,-72 , 45/* "Identifier" */,-72 , 31/* "-" */,-72 , 21/* "!" */,-72 , 41/* "String" */,-72 , 42/* "Integer" */,-72 , 43/* "Boolean" */,-72 , 44/* "Float" */,-72 , 35/* ")" */,-72 , 18/* "," */,-72 , 30/* "+" */,-72 , 33/* "*" */,-72 , 32/* "/" */,-72 , 16/* "]" */,-72 , 36/* "->" */,-72 ),
    /* State 116 */ new Array( 19/* "." */,49 , 17/* ";" */,-71 , 22/* "==" */,-71 , 29/* "<" */,-71 , 28/* ">" */,-71 , 26/* "<=" */,-71 , 27/* ">=" */,-71 , 23/* "!=" */,-71 , 7/* "RETURN" */,-71 , 39/* "Variable" */,-71 , 2/* "IF" */,-71 , 4/* "WHILE" */,-71 , 5/* "DO" */,-71 , 6/* "ECHO" */,-71 , 13/* "{" */,-71 , 34/* "(" */,-71 , 8/* "NewToken" */,-71 , 45/* "Identifier" */,-71 , 31/* "-" */,-71 , 21/* "!" */,-71 , 41/* "String" */,-71 , 42/* "Integer" */,-71 , 43/* "Boolean" */,-71 , 44/* "Float" */,-71 , 35/* ")" */,-71 , 18/* "," */,-71 , 30/* "+" */,-71 , 33/* "*" */,-71 , 32/* "/" */,-71 , 16/* "]" */,-71 , 36/* "->" */,-71 ),
    /* State 117 */ new Array( 19/* "." */,49 , 17/* ";" */,-70 , 22/* "==" */,-70 , 29/* "<" */,-70 , 28/* ">" */,-70 , 26/* "<=" */,-70 , 27/* ">=" */,-70 , 23/* "!=" */,-70 , 7/* "RETURN" */,-70 , 39/* "Variable" */,-70 , 2/* "IF" */,-70 , 4/* "WHILE" */,-70 , 5/* "DO" */,-70 , 6/* "ECHO" */,-70 , 13/* "{" */,-70 , 34/* "(" */,-70 , 8/* "NewToken" */,-70 , 45/* "Identifier" */,-70 , 31/* "-" */,-70 , 21/* "!" */,-70 , 41/* "String" */,-70 , 42/* "Integer" */,-70 , 43/* "Boolean" */,-70 , 44/* "Float" */,-70 , 35/* ")" */,-70 , 18/* "," */,-70 , 30/* "+" */,-70 , 33/* "*" */,-70 , 32/* "/" */,-70 , 16/* "]" */,-70 , 36/* "->" */,-70 ),
    /* State 118 */ new Array( 19/* "." */,49 , 17/* ";" */,-69 , 22/* "==" */,-69 , 29/* "<" */,-69 , 28/* ">" */,-69 , 26/* "<=" */,-69 , 27/* ">=" */,-69 , 23/* "!=" */,-69 , 7/* "RETURN" */,-69 , 39/* "Variable" */,-69 , 2/* "IF" */,-69 , 4/* "WHILE" */,-69 , 5/* "DO" */,-69 , 6/* "ECHO" */,-69 , 13/* "{" */,-69 , 34/* "(" */,-69 , 8/* "NewToken" */,-69 , 45/* "Identifier" */,-69 , 31/* "-" */,-69 , 21/* "!" */,-69 , 41/* "String" */,-69 , 42/* "Integer" */,-69 , 43/* "Boolean" */,-69 , 44/* "Float" */,-69 , 35/* ")" */,-69 , 18/* "," */,-69 , 30/* "+" */,-69 , 33/* "*" */,-69 , 32/* "/" */,-69 , 16/* "]" */,-69 , 36/* "->" */,-69 ),
    /* State 119 */ new Array( 18/* "," */,125 , 35/* ")" */,142 ),
    /* State 120 */ new Array( 45/* "Identifier" */,110 , 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 121 */ new Array( 17/* ";" */,-84 , 22/* "==" */,-84 , 29/* "<" */,-84 , 28/* ">" */,-84 , 26/* "<=" */,-84 , 27/* ">=" */,-84 , 23/* "!=" */,-84 , 31/* "-" */,-84 , 30/* "+" */,-84 , 33/* "*" */,-84 , 32/* "/" */,-84 , 19/* "." */,-84 , 7/* "RETURN" */,-84 , 39/* "Variable" */,-84 , 2/* "IF" */,-84 , 4/* "WHILE" */,-84 , 5/* "DO" */,-84 , 6/* "ECHO" */,-84 , 13/* "{" */,-84 , 34/* "(" */,-84 , 8/* "NewToken" */,-84 , 45/* "Identifier" */,-84 , 21/* "!" */,-84 , 41/* "String" */,-84 , 42/* "Integer" */,-84 , 43/* "Boolean" */,-84 , 44/* "Float" */,-84 , 35/* ")" */,-84 , 18/* "," */,-84 , 16/* "]" */,-84 , 36/* "->" */,-84 ),
    /* State 122 */ new Array( 17/* ";" */,-80 , 22/* "==" */,-80 , 29/* "<" */,-80 , 28/* ">" */,-80 , 26/* "<=" */,-80 , 27/* ">=" */,-80 , 23/* "!=" */,-80 , 31/* "-" */,-80 , 30/* "+" */,-80 , 19/* "." */,-80 , 7/* "RETURN" */,-80 , 39/* "Variable" */,-80 , 2/* "IF" */,-80 , 4/* "WHILE" */,-80 , 5/* "DO" */,-80 , 6/* "ECHO" */,-80 , 13/* "{" */,-80 , 34/* "(" */,-80 , 8/* "NewToken" */,-80 , 45/* "Identifier" */,-80 , 21/* "!" */,-80 , 41/* "String" */,-80 , 42/* "Integer" */,-80 , 43/* "Boolean" */,-80 , 44/* "Float" */,-80 , 35/* ")" */,-80 , 33/* "*" */,-80 , 32/* "/" */,-80 , 18/* "," */,-80 , 16/* "]" */,-80 , 36/* "->" */,-80 ),
    /* State 123 */ new Array( 17/* ";" */,-76 , 22/* "==" */,-76 , 29/* "<" */,-76 , 28/* ">" */,-76 , 26/* "<=" */,-76 , 27/* ">=" */,-76 , 23/* "!=" */,-76 , 19/* "." */,-76 , 7/* "RETURN" */,-76 , 39/* "Variable" */,-76 , 2/* "IF" */,-76 , 4/* "WHILE" */,-76 , 5/* "DO" */,-76 , 6/* "ECHO" */,-76 , 13/* "{" */,-76 , 34/* "(" */,-76 , 8/* "NewToken" */,-76 , 45/* "Identifier" */,-76 , 31/* "-" */,-76 , 21/* "!" */,-76 , 41/* "String" */,-76 , 42/* "Integer" */,-76 , 43/* "Boolean" */,-76 , 44/* "Float" */,-76 , 35/* ")" */,-76 , 30/* "+" */,-76 , 18/* "," */,-76 , 33/* "*" */,-76 , 32/* "/" */,-76 , 16/* "]" */,-76 , 36/* "->" */,-76 ),
    /* State 124 */ new Array( 17/* ";" */,-50 , 19/* "." */,-50 , 7/* "RETURN" */,-50 , 39/* "Variable" */,-50 , 2/* "IF" */,-50 , 4/* "WHILE" */,-50 , 5/* "DO" */,-50 , 6/* "ECHO" */,-50 , 13/* "{" */,-50 , 34/* "(" */,-50 , 8/* "NewToken" */,-50 , 45/* "Identifier" */,-50 , 31/* "-" */,-50 , 21/* "!" */,-50 , 41/* "String" */,-50 , 42/* "Integer" */,-50 , 43/* "Boolean" */,-50 , 44/* "Float" */,-50 , 35/* ")" */,-50 , 22/* "==" */,-50 , 29/* "<" */,-50 , 28/* ">" */,-50 , 26/* "<=" */,-50 , 27/* ">=" */,-50 , 23/* "!=" */,-50 , 18/* "," */,-50 , 30/* "+" */,-50 , 33/* "*" */,-50 , 32/* "/" */,-50 , 16/* "]" */,-50 , 36/* "->" */,-50 ),
    /* State 125 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 126 */ new Array( 17/* ";" */,-63 , 36/* "->" */,-63 , 19/* "." */,-63 , 34/* "(" */,-63 , 22/* "==" */,-63 , 29/* "<" */,-63 , 28/* ">" */,-63 , 26/* "<=" */,-63 , 27/* ">=" */,-63 , 23/* "!=" */,-63 , 31/* "-" */,-63 , 30/* "+" */,-63 , 33/* "*" */,-63 , 32/* "/" */,-63 , 7/* "RETURN" */,-63 , 39/* "Variable" */,-63 , 2/* "IF" */,-63 , 4/* "WHILE" */,-63 , 5/* "DO" */,-63 , 6/* "ECHO" */,-63 , 13/* "{" */,-63 , 8/* "NewToken" */,-63 , 45/* "Identifier" */,-63 , 21/* "!" */,-63 , 41/* "String" */,-63 , 42/* "Integer" */,-63 , 43/* "Boolean" */,-63 , 44/* "Float" */,-63 , 35/* ")" */,-63 , 18/* "," */,-63 , 16/* "]" */,-63 ),
    /* State 127 */ new Array( 32/* "/" */,88 , 33/* "*" */,89 , 17/* ";" */,-79 , 22/* "==" */,-79 , 29/* "<" */,-79 , 28/* ">" */,-79 , 26/* "<=" */,-79 , 27/* ">=" */,-79 , 23/* "!=" */,-79 , 31/* "-" */,-79 , 30/* "+" */,-79 , 19/* "." */,-79 , 7/* "RETURN" */,-79 , 39/* "Variable" */,-79 , 2/* "IF" */,-79 , 4/* "WHILE" */,-79 , 5/* "DO" */,-79 , 6/* "ECHO" */,-79 , 13/* "{" */,-79 , 34/* "(" */,-79 , 8/* "NewToken" */,-79 , 45/* "Identifier" */,-79 , 21/* "!" */,-79 , 41/* "String" */,-79 , 42/* "Integer" */,-79 , 43/* "Boolean" */,-79 , 44/* "Float" */,-79 , 35/* ")" */,-79 , 18/* "," */,-79 , 16/* "]" */,-79 , 36/* "->" */,-79 ),
    /* State 128 */ new Array( 34/* "(" */,128 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 , 39/* "Variable" */,78 , 45/* "Identifier" */,33 ),
    /* State 129 */ new Array( 32/* "/" */,88 , 33/* "*" */,89 , 17/* ";" */,-78 , 22/* "==" */,-78 , 29/* "<" */,-78 , 28/* ">" */,-78 , 26/* "<=" */,-78 , 27/* ">=" */,-78 , 23/* "!=" */,-78 , 31/* "-" */,-78 , 30/* "+" */,-78 , 19/* "." */,-78 , 7/* "RETURN" */,-78 , 39/* "Variable" */,-78 , 2/* "IF" */,-78 , 4/* "WHILE" */,-78 , 5/* "DO" */,-78 , 6/* "ECHO" */,-78 , 13/* "{" */,-78 , 34/* "(" */,-78 , 8/* "NewToken" */,-78 , 45/* "Identifier" */,-78 , 21/* "!" */,-78 , 41/* "String" */,-78 , 42/* "Integer" */,-78 , 43/* "Boolean" */,-78 , 44/* "Float" */,-78 , 35/* ")" */,-78 , 18/* "," */,-78 , 16/* "]" */,-78 , 36/* "->" */,-78 ),
    /* State 130 */ new Array( 17/* ";" */,-83 , 22/* "==" */,-83 , 29/* "<" */,-83 , 28/* ">" */,-83 , 26/* "<=" */,-83 , 27/* ">=" */,-83 , 23/* "!=" */,-83 , 31/* "-" */,-83 , 30/* "+" */,-83 , 33/* "*" */,-83 , 32/* "/" */,-83 , 19/* "." */,-83 , 7/* "RETURN" */,-83 , 39/* "Variable" */,-83 , 2/* "IF" */,-83 , 4/* "WHILE" */,-83 , 5/* "DO" */,-83 , 6/* "ECHO" */,-83 , 13/* "{" */,-83 , 34/* "(" */,-83 , 8/* "NewToken" */,-83 , 45/* "Identifier" */,-83 , 21/* "!" */,-83 , 41/* "String" */,-83 , 42/* "Integer" */,-83 , 43/* "Boolean" */,-83 , 44/* "Float" */,-83 , 35/* ")" */,-83 , 18/* "," */,-83 , 16/* "]" */,-83 , 36/* "->" */,-83 ),
    /* State 131 */ new Array( 17/* ";" */,-82 , 22/* "==" */,-82 , 29/* "<" */,-82 , 28/* ">" */,-82 , 26/* "<=" */,-82 , 27/* ">=" */,-82 , 23/* "!=" */,-82 , 31/* "-" */,-82 , 30/* "+" */,-82 , 33/* "*" */,-82 , 32/* "/" */,-82 , 19/* "." */,-82 , 7/* "RETURN" */,-82 , 39/* "Variable" */,-82 , 2/* "IF" */,-82 , 4/* "WHILE" */,-82 , 5/* "DO" */,-82 , 6/* "ECHO" */,-82 , 13/* "{" */,-82 , 34/* "(" */,-82 , 8/* "NewToken" */,-82 , 45/* "Identifier" */,-82 , 21/* "!" */,-82 , 41/* "String" */,-82 , 42/* "Integer" */,-82 , 43/* "Boolean" */,-82 , 44/* "Float" */,-82 , 35/* ")" */,-82 , 18/* "," */,-82 , 16/* "]" */,-82 , 36/* "->" */,-82 ),
    /* State 132 */ new Array( 2/* "IF" */,13 , 4/* "WHILE" */,14 , 5/* "DO" */,15 , 6/* "ECHO" */,16 , 39/* "Variable" */,17 , 13/* "{" */,18 , 7/* "RETURN" */,21 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 133 */ new Array( 19/* "." */,49 , 17/* ";" */,146 ),
    /* State 134 */ new Array( 19/* "." */,49 , 16/* "]" */,147 ),
    /* State 135 */ new Array( 19/* "." */,49 , 17/* ";" */,148 ),
    /* State 136 */ new Array( 20/* "=" */,-68 , 17/* ";" */,-68 , 19/* "." */,-68 , 15/* "[" */,-68 , 36/* "->" */,-68 , 34/* "(" */,-68 , 22/* "==" */,-68 , 29/* "<" */,-68 , 28/* ">" */,-68 , 26/* "<=" */,-68 , 27/* ">=" */,-68 , 23/* "!=" */,-68 , 31/* "-" */,-68 , 30/* "+" */,-68 , 33/* "*" */,-68 , 32/* "/" */,-68 , 7/* "RETURN" */,-68 , 39/* "Variable" */,-68 , 2/* "IF" */,-68 , 4/* "WHILE" */,-68 , 5/* "DO" */,-68 , 6/* "ECHO" */,-68 , 13/* "{" */,-68 , 8/* "NewToken" */,-68 , 45/* "Identifier" */,-68 , 21/* "!" */,-68 , 41/* "String" */,-68 , 42/* "Integer" */,-68 , 43/* "Boolean" */,-68 , 44/* "Float" */,-68 , 35/* ")" */,-68 , 18/* "," */,-68 , 16/* "]" */,-68 ),
    /* State 137 */ new Array( 14/* "}" */,151 , 10/* "PublicToken" */,154 , 12/* "ProtectedToken" */,155 , 11/* "PrivateToken" */,156 , 40/* "FunctionName" */,-12 ),
    /* State 138 */ new Array( 39/* "Variable" */,157 ),
    /* State 139 */ new Array( 13/* "{" */,158 ),
    /* State 140 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 141 */ new Array( 18/* "," */,125 , 35/* ")" */,160 ),
    /* State 142 */ new Array( 17/* ";" */,-49 , 19/* "." */,-49 , 7/* "RETURN" */,-49 , 39/* "Variable" */,-49 , 2/* "IF" */,-49 , 4/* "WHILE" */,-49 , 5/* "DO" */,-49 , 6/* "ECHO" */,-49 , 13/* "{" */,-49 , 34/* "(" */,-49 , 8/* "NewToken" */,-49 , 45/* "Identifier" */,-49 , 31/* "-" */,-49 , 21/* "!" */,-49 , 41/* "String" */,-49 , 42/* "Integer" */,-49 , 43/* "Boolean" */,-49 , 44/* "Float" */,-49 , 35/* ")" */,-49 , 18/* "," */,-49 , 22/* "==" */,-49 , 29/* "<" */,-49 , 28/* ">" */,-49 , 26/* "<=" */,-49 , 27/* ">=" */,-49 , 23/* "!=" */,-49 , 30/* "+" */,-49 , 33/* "*" */,-49 , 32/* "/" */,-49 , 16/* "]" */,-49 , 36/* "->" */,-49 ),
    /* State 143 */ new Array( 19/* "." */,49 , 35/* ")" */,-64 , 18/* "," */,-64 ),
    /* State 144 */ new Array( 32/* "/" */,88 , 33/* "*" */,89 , 35/* ")" */,121 ),
    /* State 145 */ new Array( 47/* "ScriptEnd" */,-23 , 48/* "InternalNonScript" */,-23 , 38/* "//" */,-23 , 7/* "RETURN" */,-23 , 39/* "Variable" */,-23 , 2/* "IF" */,-23 , 4/* "WHILE" */,-23 , 5/* "DO" */,-23 , 6/* "ECHO" */,-23 , 13/* "{" */,-23 , 9/* "ClassToken" */,-23 , 40/* "FunctionName" */,-23 , 34/* "(" */,-23 , 8/* "NewToken" */,-23 , 45/* "Identifier" */,-23 , 31/* "-" */,-23 , 21/* "!" */,-23 , 41/* "String" */,-23 , 42/* "Integer" */,-23 , 43/* "Boolean" */,-23 , 44/* "Float" */,-23 , 14/* "}" */,-23 , 3/* "ELSE" */,-23 ),
    /* State 146 */ new Array( 47/* "ScriptEnd" */,-25 , 48/* "InternalNonScript" */,-25 , 38/* "//" */,-25 , 7/* "RETURN" */,-25 , 39/* "Variable" */,-25 , 2/* "IF" */,-25 , 4/* "WHILE" */,-25 , 5/* "DO" */,-25 , 6/* "ECHO" */,-25 , 13/* "{" */,-25 , 9/* "ClassToken" */,-25 , 40/* "FunctionName" */,-25 , 34/* "(" */,-25 , 8/* "NewToken" */,-25 , 45/* "Identifier" */,-25 , 31/* "-" */,-25 , 21/* "!" */,-25 , 41/* "String" */,-25 , 42/* "Integer" */,-25 , 43/* "Boolean" */,-25 , 44/* "Float" */,-25 , 14/* "}" */,-25 , 3/* "ELSE" */,-25 ),
    /* State 147 */ new Array( 20/* "=" */,-67 , 17/* ";" */,-67 , 19/* "." */,-67 , 15/* "[" */,-67 , 36/* "->" */,-67 , 34/* "(" */,-67 , 22/* "==" */,-67 , 29/* "<" */,-67 , 28/* ">" */,-67 , 26/* "<=" */,-67 , 27/* ">=" */,-67 , 23/* "!=" */,-67 , 31/* "-" */,-67 , 30/* "+" */,-67 , 33/* "*" */,-67 , 32/* "/" */,-67 , 7/* "RETURN" */,-67 , 39/* "Variable" */,-67 , 2/* "IF" */,-67 , 4/* "WHILE" */,-67 , 5/* "DO" */,-67 , 6/* "ECHO" */,-67 , 13/* "{" */,-67 , 8/* "NewToken" */,-67 , 45/* "Identifier" */,-67 , 21/* "!" */,-67 , 41/* "String" */,-67 , 42/* "Integer" */,-67 , 43/* "Boolean" */,-67 , 44/* "Float" */,-67 , 35/* ")" */,-67 , 18/* "," */,-67 , 16/* "]" */,-67 ),
    /* State 148 */ new Array( 47/* "ScriptEnd" */,-27 , 48/* "InternalNonScript" */,-27 , 38/* "//" */,-27 , 7/* "RETURN" */,-27 , 39/* "Variable" */,-27 , 2/* "IF" */,-27 , 4/* "WHILE" */,-27 , 5/* "DO" */,-27 , 6/* "ECHO" */,-27 , 13/* "{" */,-27 , 9/* "ClassToken" */,-27 , 40/* "FunctionName" */,-27 , 34/* "(" */,-27 , 8/* "NewToken" */,-27 , 45/* "Identifier" */,-27 , 31/* "-" */,-27 , 21/* "!" */,-27 , 41/* "String" */,-27 , 42/* "Integer" */,-27 , 43/* "Boolean" */,-27 , 44/* "Float" */,-27 , 14/* "}" */,-27 , 3/* "ELSE" */,-27 ),
    /* State 149 */ new Array( 14/* "}" */,-6 , 10/* "PublicToken" */,-6 , 12/* "ProtectedToken" */,-6 , 11/* "PrivateToken" */,-6 , 40/* "FunctionName" */,-6 ),
    /* State 150 */ new Array( 14/* "}" */,-5 , 10/* "PublicToken" */,-5 , 12/* "ProtectedToken" */,-5 , 11/* "PrivateToken" */,-5 , 40/* "FunctionName" */,-5 ),
    /* State 151 */ new Array( 47/* "ScriptEnd" */,-4 , 48/* "InternalNonScript" */,-4 , 38/* "//" */,-4 , 7/* "RETURN" */,-4 , 39/* "Variable" */,-4 , 2/* "IF" */,-4 , 4/* "WHILE" */,-4 , 5/* "DO" */,-4 , 6/* "ECHO" */,-4 , 13/* "{" */,-4 , 9/* "ClassToken" */,-4 , 40/* "FunctionName" */,-4 , 34/* "(" */,-4 , 8/* "NewToken" */,-4 , 45/* "Identifier" */,-4 , 31/* "-" */,-4 , 21/* "!" */,-4 , 41/* "String" */,-4 , 42/* "Integer" */,-4 , 43/* "Boolean" */,-4 , 44/* "Float" */,-4 , 14/* "}" */,-4 ),
    /* State 152 */ new Array( 39/* "Variable" */,161 ),
    /* State 153 */ new Array( 40/* "FunctionName" */,162 ),
    /* State 154 */ new Array( 39/* "Variable" */,-8 , 40/* "FunctionName" */,-11 ),
    /* State 155 */ new Array( 39/* "Variable" */,-9 , 40/* "FunctionName" */,-13 ),
    /* State 156 */ new Array( 39/* "Variable" */,-10 , 40/* "FunctionName" */,-14 ),
    /* State 157 */ new Array( 35/* ")" */,-40 , 18/* "," */,-40 ),
    /* State 158 */ new Array( 48/* "InternalNonScript" */,8 , 38/* "//" */,9 , 2/* "IF" */,13 , 4/* "WHILE" */,14 , 5/* "DO" */,15 , 6/* "ECHO" */,16 , 39/* "Variable" */,17 , 13/* "{" */,18 , 9/* "ClassToken" */,19 , 40/* "FunctionName" */,20 , 7/* "RETURN" */,21 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 159 */ new Array( 19/* "." */,49 , 17/* ";" */,-36 , 7/* "RETURN" */,-36 , 39/* "Variable" */,-36 , 2/* "IF" */,-36 , 4/* "WHILE" */,-36 , 5/* "DO" */,-36 , 6/* "ECHO" */,-36 , 13/* "{" */,-36 , 34/* "(" */,-36 , 8/* "NewToken" */,-36 , 45/* "Identifier" */,-36 , 31/* "-" */,-36 , 21/* "!" */,-36 , 41/* "String" */,-36 , 42/* "Integer" */,-36 , 43/* "Boolean" */,-36 , 44/* "Float" */,-36 , 36/* "->" */,-36 , 22/* "==" */,-36 , 29/* "<" */,-36 , 28/* ">" */,-36 , 26/* "<=" */,-36 , 27/* ">=" */,-36 , 23/* "!=" */,-36 , 30/* "+" */,-36 , 33/* "*" */,-36 , 32/* "/" */,-36 , 35/* ")" */,-36 , 18/* "," */,-36 , 16/* "]" */,-36 ),
    /* State 160 */ new Array( 17/* ";" */,-62 , 36/* "->" */,-62 , 19/* "." */,-62 , 34/* "(" */,-62 , 22/* "==" */,-62 , 29/* "<" */,-62 , 28/* ">" */,-62 , 26/* "<=" */,-62 , 27/* ">=" */,-62 , 23/* "!=" */,-62 , 31/* "-" */,-62 , 30/* "+" */,-62 , 33/* "*" */,-62 , 32/* "/" */,-62 , 7/* "RETURN" */,-62 , 39/* "Variable" */,-62 , 2/* "IF" */,-62 , 4/* "WHILE" */,-62 , 5/* "DO" */,-62 , 6/* "ECHO" */,-62 , 13/* "{" */,-62 , 8/* "NewToken" */,-62 , 45/* "Identifier" */,-62 , 21/* "!" */,-62 , 41/* "String" */,-62 , 42/* "Integer" */,-62 , 43/* "Boolean" */,-62 , 44/* "Float" */,-62 , 35/* ")" */,-62 , 18/* "," */,-62 , 16/* "]" */,-62 , 20/* "=" */,-62 ),
    /* State 161 */ new Array( 17/* ";" */,164 , 20/* "=" */,165 ),
    /* State 162 */ new Array( 34/* "(" */,166 ),
    /* State 163 */ new Array( 14/* "}" */,167 , 48/* "InternalNonScript" */,8 , 38/* "//" */,9 , 2/* "IF" */,13 , 4/* "WHILE" */,14 , 5/* "DO" */,15 , 6/* "ECHO" */,16 , 39/* "Variable" */,17 , 13/* "{" */,18 , 9/* "ClassToken" */,19 , 40/* "FunctionName" */,20 , 7/* "RETURN" */,21 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 164 */ new Array( 14/* "}" */,-17 , 10/* "PublicToken" */,-17 , 12/* "ProtectedToken" */,-17 , 11/* "PrivateToken" */,-17 , 40/* "FunctionName" */,-17 ),
    /* State 165 */ new Array( 39/* "Variable" */,53 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 166 */ new Array( 39/* "Variable" */,107 , 35/* ")" */,-42 , 18/* "," */,-42 ),
    /* State 167 */ new Array( 47/* "ScriptEnd" */,-15 , 48/* "InternalNonScript" */,-15 , 38/* "//" */,-15 , 7/* "RETURN" */,-15 , 39/* "Variable" */,-15 , 2/* "IF" */,-15 , 4/* "WHILE" */,-15 , 5/* "DO" */,-15 , 6/* "ECHO" */,-15 , 13/* "{" */,-15 , 9/* "ClassToken" */,-15 , 40/* "FunctionName" */,-15 , 34/* "(" */,-15 , 8/* "NewToken" */,-15 , 45/* "Identifier" */,-15 , 31/* "-" */,-15 , 21/* "!" */,-15 , 41/* "String" */,-15 , 42/* "Integer" */,-15 , 43/* "Boolean" */,-15 , 44/* "Float" */,-15 , 14/* "}" */,-15 ),
    /* State 168 */ new Array( 19/* "." */,49 , 17/* ";" */,170 ),
    /* State 169 */ new Array( 18/* "," */,138 , 35/* ")" */,171 ),
    /* State 170 */ new Array( 14/* "}" */,-18 , 10/* "PublicToken" */,-18 , 12/* "ProtectedToken" */,-18 , 11/* "PrivateToken" */,-18 , 40/* "FunctionName" */,-18 ),
    /* State 171 */ new Array( 13/* "{" */,172 ),
    /* State 172 */ new Array( 48/* "InternalNonScript" */,8 , 38/* "//" */,9 , 2/* "IF" */,13 , 4/* "WHILE" */,14 , 5/* "DO" */,15 , 6/* "ECHO" */,16 , 39/* "Variable" */,17 , 13/* "{" */,18 , 9/* "ClassToken" */,19 , 40/* "FunctionName" */,20 , 7/* "RETURN" */,21 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 173 */ new Array( 14/* "}" */,174 , 48/* "InternalNonScript" */,8 , 38/* "//" */,9 , 2/* "IF" */,13 , 4/* "WHILE" */,14 , 5/* "DO" */,15 , 6/* "ECHO" */,16 , 39/* "Variable" */,17 , 13/* "{" */,18 , 9/* "ClassToken" */,19 , 40/* "FunctionName" */,20 , 7/* "RETURN" */,21 , 8/* "NewToken" */,29 , 34/* "(" */,30 , 45/* "Identifier" */,33 , 31/* "-" */,36 , 21/* "!" */,37 , 41/* "String" */,39 , 42/* "Integer" */,40 , 43/* "Boolean" */,41 , 44/* "Float" */,42 ),
    /* State 174 */ new Array( 14/* "}" */,-16 , 10/* "PublicToken" */,-16 , 12/* "ProtectedToken" */,-16 , 11/* "PrivateToken" */,-16 , 40/* "FunctionName" */,-16 )
);
...
var goto_tab = new Array(
    ...
    /* State 2 */ new Array( ),
    /* State 3 */ new Array( 51/* Stmt */,4 , 63/* SingleStmt */,5 , 53/* ClassDefinition */,6 , 59/* FunctionDefinition */,7 , 61/* Return */,10 , 62/* AssignmentStmt */,11 , 60/* Expression */,12 , 66/* LValue */,22 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 68/* BinaryExp */,27 , 67/* AttributeAccess */,28 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 4 */ new Array( 51/* Stmt */,43 , 63/* SingleStmt */,5 , 53/* ClassDefinition */,6 , 59/* FunctionDefinition */,7 , 61/* Return */,10 , 62/* AssignmentStmt */,11 , 60/* Expression */,12 , 66/* LValue */,22 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 68/* BinaryExp */,27 , 67/* AttributeAccess */,28 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 5 */ new Array( ),
    /* State 6 */ new Array( ),
    /* State 7 */ new Array( ),
    /* State 8 */ new Array( ),
    /* State 9 */ new Array( 65/* AssertStmt */,45 ),
    /* State 10 */ new Array( ),
    /* State 11 */ new Array( ),
    /* State 12 */ new Array( ),
    /* State 13 */ new Array( 60/* Expression */,51 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 14 */ new Array( 60/* Expression */,54 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 15 */ new Array( 63/* SingleStmt */,55 , 61/* Return */,10 , 62/* AssignmentStmt */,11 , 60/* Expression */,12 , 66/* LValue */,22 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 68/* BinaryExp */,27 , 67/* AttributeAccess */,28 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 16 */ new Array( 60/* Expression */,56 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 17 */ new Array( 64/* ArrayIndices */,57 ),
    /* State 18 */ new Array( 51/* Stmt */,60 , 63/* SingleStmt */,5 , 53/* ClassDefinition */,6 , 59/* FunctionDefinition */,7 , 61/* Return */,10 , 62/* AssignmentStmt */,11 , 60/* Expression */,12 , 66/* LValue */,22 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 68/* BinaryExp */,27 , 67/* AttributeAccess */,28 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 19 */ new Array( ),
    /* State 20 */ new Array( ),
    /* State 21 */ new Array( 60/* Expression */,63 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 22 */ new Array( ),
    /* State 23 */ new Array( ),
    /* State 24 */ new Array( ),
    /* State 25 */ new Array( ),
    /* State 26 */ new Array( 64/* ArrayIndices */,66 ),
    /* State 27 */ new Array( ),
    /* State 28 */ new Array( ),
    /* State 29 */ new Array( 69/* FunctionInvoke */,73 , 66/* LValue */,74 , 72/* MemberAccess */,25 , 73/* VarVal */,75 , 74/* FunctionAccess */,76 , 67/* AttributeAccess */,77 ),
    /* State 30 */ new Array( 76/* MulDivExp */,79 , 75/* AddSubExp */,80 , 68/* BinaryExp */,81 , 60/* Expression */,82 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 77/* UnaryExp */,35 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 78/* Value */,38 , 72/* MemberAccess */,25 , 73/* VarVal */,26 ),
    /* State 31 */ new Array( 70/* ActualParameterList */,83 , 60/* Expression */,84 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 32 */ new Array( ),
    /* State 33 */ new Array( ),
    /* State 34 */ new Array( ),
    /* State 35 */ new Array( ),
    /* State 36 */ new Array( 78/* Value */,90 , 73/* VarVal */,26 , 66/* LValue */,91 , 72/* MemberAccess */,25 , 74/* FunctionAccess */,76 , 67/* AttributeAccess */,77 , 69/* FunctionInvoke */,31 ),
    /* State 37 */ new Array( 60/* Expression */,92 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 38 */ new Array( ),
    /* State 39 */ new Array( ),
    /* State 40 */ new Array( ),
    /* State 41 */ new Array( ),
    /* State 42 */ new Array( ),
    /* State 43 */ new Array( 51/* Stmt */,43 , 63/* SingleStmt */,5 , 53/* ClassDefinition */,6 , 59/* FunctionDefinition */,7 , 61/* Return */,10 , 62/* AssignmentStmt */,11 , 60/* Expression */,12 , 66/* LValue */,22 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 68/* BinaryExp */,27 , 67/* AttributeAccess */,28 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 44 */ new Array( ),
    /* State 45 */ new Array( ),
    /* State 46 */ new Array( ),
    /* State 47 */ new Array( ),
    /* State 48 */ new Array( ),
    /* State 49 */ new Array( 60/* Expression */,94 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 50 */ new Array( ),
    /* State 51 */ new Array( 63/* SingleStmt */,95 , 61/* Return */,10 , 62/* AssignmentStmt */,11 , 60/* Expression */,12 , 66/* LValue */,22 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 68/* BinaryExp */,27 , 67/* AttributeAccess */,28 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 52 */ new Array( ),
    /* State 53 */ new Array( 64/* ArrayIndices */,96 ),
    /* State 54 */ new Array( 63/* SingleStmt */,97 , 61/* Return */,10 , 62/* AssignmentStmt */,11 , 60/* Expression */,12 , 66/* LValue */,22 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 68/* BinaryExp */,27 , 67/* AttributeAccess */,28 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 55 */ new Array( ),
    /* State 56 */ new Array( ),
    /* State 57 */ new Array( ),
    /* State 58 */ new Array( 60/* Expression */,102 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 59 */ new Array( 60/* Expression */,103 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 60 */ new Array( 51/* Stmt */,43 , 63/* SingleStmt */,5 , 53/* ClassDefinition */,6 , 59/* FunctionDefinition */,7 , 61/* Return */,10 , 62/* AssignmentStmt */,11 , 60/* Expression */,12 , 66/* LValue */,22 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 68/* BinaryExp */,27 , 67/* AttributeAccess */,28 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 61 */ new Array( ),
    /* State 62 */ new Array( 58/* FormalParameterList */,106 ),
    /* State 63 */ new Array( ),
    /* State 64 */ new Array( ),
    /* State 65 */ new Array( 67/* AttributeAccess */,108 , 69/* FunctionInvoke */,109 , 71/* ExpressionNotFunAccess */,111 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 66/* LValue */,22 , 60/* Expression */,112 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 74/* FunctionAccess */,24 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 66 */ new Array( ),
    /* State 67 */ new Array( 60/* Expression */,113 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 68 */ new Array( 60/* Expression */,114 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 69 */ new Array( 60/* Expression */,115 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 70 */ new Array( 60/* Expression */,116 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 71 */ new Array( 60/* Expression */,117 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 72 */ new Array( 60/* Expression */,118 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 73 */ new Array( 70/* ActualParameterList */,119 , 60/* Expression */,84 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 74 */ new Array( ),
    /* State 75 */ new Array( 64/* ArrayIndices */,66 ),
    /* State 76 */ new Array( ),
    /* State 77 */ new Array( ),
    /* State 78 */ new Array( ),
    /* State 79 */ new Array( ),
    ...
    /* State 83 */ new Array( ),
    /* State 84 */ new Array( ),
    /* State 85 */ new Array( 76/* MulDivExp */,127 , 77/* UnaryExp */,35 , 78/* Value */,38 , 73/* VarVal */,26 , 66/* LValue */,91 , 72/* MemberAccess */,25 , 74/* FunctionAccess */,76 , 67/* AttributeAccess */,77 , 69/* FunctionInvoke */,31 ),
    /* State 86 */ new Array( 76/* MulDivExp */,129 , 77/* UnaryExp */,35 , 78/* Value */,38 , 73/* VarVal */,26 , 66/* LValue */,91 , 72/* MemberAccess */,25 , 74/* FunctionAccess */,76 , 67/* AttributeAccess */,77 , 69/* FunctionInvoke */,31 ),
    /* State 87 */ new Array( ),
    /* State 88 */ new Array( 77/* UnaryExp */,130 , 78/* Value */,38 , 73/* VarVal */,26 , 66/* LValue */,91 , 72/* MemberAccess */,25 , 74/* FunctionAccess */,76 , 67/* AttributeAccess */,77 , 69/* FunctionInvoke */,31 ),
    /* State 89 */ new Array( 77/* UnaryExp */,131 , 78/* Value */,38 , 73/* VarVal */,26 , 66/* LValue */,91 , 72/* MemberAccess */,25 , 74/* FunctionAccess */,76 , 67/* AttributeAccess */,77 , 69/* FunctionInvoke */,31 ),
    /* State 90 */ new Array( ),
    /* State 91 */ new Array( ),
    /* State 92 */ new Array( ),
    /* State 93 */ new Array( ),
    ...
    /* State 96 */ new Array( ),
    /* State 97 */ new Array( ),
    /* State 98 */ new Array( 60/* Expression */,133 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 99 */ new Array( ),
    /* State 100 */ new Array( 60/* Expression */,134 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 101 */ new Array( 60/* Expression */,135 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 102 */ new Array( ),
    /* State 103 */ new Array( ),
    /* State 104 */ new Array( ),
    /* State 105 */ new Array( 52/* Member */,137 ),
    /* State 106 */ new Array( ),
    /* State 107 */ new Array( ),
    /* State 108 */ new Array( ),
    /* State 109 */ new Array( 70/* ActualParameterList */,141 , 60/* Expression */,84 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 110 */ new Array( ),
    /* State 111 */ new Array( ),
    /* State 112 */ new Array( ),
    /* State 113 */ new Array( ),
    ...
    /* State 118 */ new Array( ),
    /* State 119 */ new Array( ),
    /* State 120 */ new Array( 69/* FunctionInvoke */,109 , 71/* ExpressionNotFunAccess */,111 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 60/* Expression */,112 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 74/* FunctionAccess */,24 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 121 */ new Array( ),
    /* State 122 */ new Array( ),
    /* State 123 */ new Array( ),
    /* State 124 */ new Array( ),
    /* State 125 */ new Array( 60/* Expression */,143 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 126 */ new Array( ),
    /* State 127 */ new Array( ),
    /* State 128 */ new Array( 76/* MulDivExp */,144 , 77/* UnaryExp */,35 , 78/* Value */,38 , 73/* VarVal */,26 , 66/* LValue */,91 , 72/* MemberAccess */,25 , 74/* FunctionAccess */,76 , 67/* AttributeAccess */,77 , 69/* FunctionInvoke */,31 ),
    /* State 129 */ new Array( ),
    /* State 130 */ new Array( ),
    /* State 131 */ new Array( ),
    /* State 132 */ new Array( 63/* SingleStmt */,145 , 61/* Return */,10 , 62/* AssignmentStmt */,11 , 60/* Expression */,12 , 66/* LValue */,22 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 68/* BinaryExp */,27 , 67/* AttributeAccess */,28 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 133 */ new Array( ),
    /* State 134 */ new Array( ),
    /* State 135 */ new Array( ),
    /* State 136 */ new Array( ),
    /* State 137 */ new Array( 55/* ClassFunctionDefinition */,149 , 54/* AttributeDefinition */,150 , 56/* AttributeMod */,152 , 57/* FunctionMod */,153 ),
    /* State 138 */ new Array( ),
    /* State 139 */ new Array( ),
    /* State 140 */ new Array( 60/* Expression */,159 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 141 */ new Array( ),
    /* State 142 */ new Array( ),
    /* State 143 */ new Array( ),
    /* State 144 */ new Array( ),
    ...
    /* State 156 */ new Array( ),
    /* State 157 */ new Array( ),
    /* State 158 */ new Array( 51/* Stmt */,163 , 63/* SingleStmt */,5 , 53/* ClassDefinition */,6 , 59/* FunctionDefinition */,7 , 61/* Return */,10 , 62/* AssignmentStmt */,11 , 60/* Expression */,12 , 66/* LValue */,22 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 68/* BinaryExp */,27 , 67/* AttributeAccess */,28 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 159 */ new Array( ),
    /* State 160 */ new Array( ),
    /* State 161 */ new Array( ),
    /* State 162 */ new Array( ),
    /* State 163 */ new Array( 51/* Stmt */,43 , 63/* SingleStmt */,5 , 53/* ClassDefinition */,6 , 59/* FunctionDefinition */,7 , 61/* Return */,10 , 62/* AssignmentStmt */,11 , 60/* Expression */,12 , 66/* LValue */,22 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 68/* BinaryExp */,27 , 67/* AttributeAccess */,28 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 164 */ new Array( ),
    /* State 165 */ new Array( 60/* Expression */,168 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 68/* BinaryExp */,27 , 62/* AssignmentStmt */,52 , 67/* AttributeAccess */,28 , 66/* LValue */,22 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 166 */ new Array( 58/* FormalParameterList */,169 ),
    /* State 167 */ new Array( ),
    /* State 168 */ new Array( ),
    /* State 169 */ new Array( ),
    /* State 170 */ new Array( ),
    /* State 171 */ new Array( ),
    /* State 172 */ new Array( 51/* Stmt */,173 , 63/* SingleStmt */,5 , 53/* ClassDefinition */,6 , 59/* FunctionDefinition */,7 , 61/* Return */,10 , 62/* AssignmentStmt */,11 , 60/* Expression */,12 , 66/* LValue */,22 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 68/* BinaryExp */,27 , 67/* AttributeAccess */,28 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 173 */ new Array( 51/* Stmt */,43 , 63/* SingleStmt */,5 , 53/* ClassDefinition */,6 , 59/* FunctionDefinition */,7 , 61/* Return */,10 , 62/* AssignmentStmt */,11 , 60/* Expression */,12 , 66/* LValue */,22 , 71/* ExpressionNotFunAccess */,23 , 74/* FunctionAccess */,24 , 72/* MemberAccess */,25 , 73/* VarVal */,26 , 68/* BinaryExp */,27 , 67/* AttributeAccess */,28 , 69/* FunctionInvoke */,31 , 75/* AddSubExp */,32 , 76/* MulDivExp */,34 , 77/* UnaryExp */,35 , 78/* Value */,38 ),
    /* State 174 */ new Array( )
);
...
{ act = 176; for( var i = 0; i < act_tab[sstack[sstack.length-1]].length; i+=2 )
...
info.offset++; while( act == 176 && sstack.length > 0 )
{ sstack.pop(); vstack.pop(); if( sstack.length == 0 )
break; act = 176; for( var i = 0; i < act_tab[sstack[sstack.length-1]].length; i+=2 )
{ if( act_tab[sstack[sstack.length-1]][i] == la )
{ act = act_tab[sstack[sstack.length-1]][i+1]; break;}
}
}
