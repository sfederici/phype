...
var act_tab = new Array(
    ...
    /* State 50 */ new Array( 33/* "(" */,84 , 19/* "." */,39 , 22/* "!=" */,40 , 26/* ">=" */,41 , 25/* "<=" */,42 , 27/* ">" */,43 , 28/* "<" */,44 , 21/* "==" */,45 , 2/* "IF" */,7 , 4/* "WHILE" */,8 , 5/* "DO" */,9 , 6/* "ECHO" */,10 , 38/* "Variable" */,11 , 13/* "{" */,15 , 46/* "InternalNonScript" */,16 , 37/* "//" */,17 , 7/* "RETURN" */,18 , 8/* "NewToken" */,20 , 9/* "ClassToken" */,23 , 39/* "FunctionName" */,24 , 40/* "Identifier" */,28 , 30/* "-" */,30 , 41/* "String" */,32 , 42/* "Integer" */,33 , 43/* "Float" */,34 , 35/* "->" */,-43 ),
    ...
    /* State 88 */ new Array( 2/* "IF" */,7 , 4/* "WHILE" */,8 , 5/* "DO" */,9 , 6/* "ECHO" */,10 , 38/* "Variable" */,11 , 13/* "{" */,15 , 46/* "InternalNonScript" */,16 , 37/* "//" */,17 , 7/* "RETURN" */,18 , 8/* "NewToken" */,20 , 33/* "(" */,22 , 9/* "ClassToken" */,23 , 39/* "FunctionName" */,24 , 40/* "Identifier" */,28 , 30/* "-" */,30 , 41/* "String" */,32 , 42/* "Integer" */,33 , 43/* "Float" */,34 , 45/* "ScriptEnd" */,-24 , 14/* "}" */,-24 , 3/* "ELSE" */,-24 ),
    ...
    /* State 93 */ new Array( 33/* "(" */,38 , 19/* "." */,39 , 22/* "!=" */,40 , 26/* ">=" */,41 , 25/* "<=" */,42 , 27/* ">" */,43 , 28/* "<" */,44 , 21/* "==" */,45 , 17/* ";" */,126 , 35/* "->" */,-43 ),
    /* State 94 */ new Array( 33/* "(" */,38 , 19/* "." */,39 , 22/* "!=" */,40 , 26/* ">=" */,41 , 25/* "<=" */,42 , 27/* ">" */,43 , 28/* "<" */,44 , 21/* "==" */,45 , 16/* "]" */,127 , 35/* "->" */,-43 ),
    /* State 95 */ new Array( 20/* "=" */,128 , 17/* ";" */,-58 , 35/* "->" */,-58 , 21/* "==" */,-58 , 28/* "<" */,-58 , 27/* ">" */,-58 , 25/* "<=" */,-58 , 26/* ">=" */,-58 , 22/* "!=" */,-58 , 19/* "." */,-58 , 33/* "(" */,-58 ),
    ...
    /* State 107 */ new Array( 18/* "," */,114 , 34/* ")" */,133 ),
    ...
    /* State 110 */ new Array( 18/* "," */,135 , 34/* ")" */,136 ),
    ...
    /* State 118 */ new Array( 33/* "(" */,38 , 19/* "." */,39 , 22/* "!=" */,40 , 26/* ">=" */,41 , 25/* "<=" */,42 , 27/* ">" */,43 , 28/* "<" */,44 , 21/* "==" */,45 , 34/* ")" */,138 , 35/* "->" */,-43 ),
    /* State 119 */ new Array( 17/* ";" */,-62 , 35/* "->" */,-62 , 21/* "==" */,-62 , 28/* "<" */,-62 , 27/* ">" */,-62 , 25/* "<=" */,-62 , 26/* ">=" */,-62 , 22/* "!=" */,-62 , 19/* "." */,-62 , 33/* "(" */,-62 , 8/* "NewToken" */,-62 , 38/* "Variable" */,-62 , 18/* "," */,-62 , 40/* "Identifier" */,-62 , 30/* "-" */,-62 , 41/* "String" */,-62 , 42/* "Integer" */,-62 , 43/* "Float" */,-62 , 34/* ")" */,-62 , 2/* "IF" */,-62 , 4/* "WHILE" */,-62 , 5/* "DO" */,-62 , 6/* "ECHO" */,-62 , 13/* "{" */,-62 , 46/* "InternalNonScript" */,-62 , 37/* "//" */,-62 , 7/* "RETURN" */,-62 , 9/* "ClassToken" */,-62 , 39/* "FunctionName" */,-62 , 20/* "=" */,-62 , 16/* "]" */,-62 ),
    ...
    /* State 123 */ new Array( 33/* "(" */,84 , 19/* "." */,39 , 22/* "!=" */,40 , 26/* ">=" */,41 , 25/* "<=" */,42 , 27/* ">" */,43 , 28/* "<" */,44 , 21/* "==" */,45 , 17/* ";" */,140 , 2/* "IF" */,7 , 4/* "WHILE" */,8 , 5/* "DO" */,9 , 6/* "ECHO" */,10 , 38/* "Variable" */,11 , 13/* "{" */,15 , 46/* "InternalNonScript" */,16 , 37/* "//" */,17 , 7/* "RETURN" */,18 , 8/* "NewToken" */,20 , 9/* "ClassToken" */,23 , 39/* "FunctionName" */,24 , 40/* "Identifier" */,28 , 30/* "-" */,30 , 41/* "String" */,32 , 42/* "Integer" */,33 , 43/* "Float" */,34 , 35/* "->" */,-43 ),
    /* State 124 */ new Array( 33/* "(" */,38 , 19/* "." */,39 , 22/* "!=" */,40 , 26/* ">=" */,41 , 25/* "<=" */,42 , 27/* ">" */,43 , 28/* "<" */,44 , 21/* "==" */,45 , 16/* "]" */,141 , 35/* "->" */,-43 ),
    /* State 125 */ new Array( 33/* "(" */,38 , 19/* "." */,39 , 22/* "!=" */,40 , 26/* ">=" */,41 , 25/* "<=" */,42 , 27/* ">" */,43 , 28/* "<" */,44 , 21/* "==" */,45 , 17/* ";" */,142 , 35/* "->" */,-43 ),
    /* State 126 */ new Array( 45/* "ScriptEnd" */,-27 , 2/* "IF" */,-27 , 4/* "WHILE" */,-27 , 5/* "DO" */,-27 , 6/* "ECHO" */,-27 , 38/* "Variable" */,-27 , 13/* "{" */,-27 , 46/* "InternalNonScript" */,-27 , 37/* "//" */,-27 , 7/* "RETURN" */,-27 , 8/* "NewToken" */,-27 , 33/* "(" */,-27 , 9/* "ClassToken" */,-27 , 39/* "FunctionName" */,-27 , 40/* "Identifier" */,-27 , 30/* "-" */,-27 , 41/* "String" */,-27 , 42/* "Integer" */,-27 , 43/* "Float" */,-27 , 14/* "}" */,-27 , 3/* "ELSE" */,-27 ),
    /* State 127 */ new Array( 20/* "=" */,-67 , 17/* ";" */,-67 , 35/* "->" */,-67 , 21/* "==" */,-67 , 28/* "<" */,-67 , 27/* ">" */,-67 , 25/* "<=" */,-67 , 26/* ">=" */,-67 , 22/* "!=" */,-67 , 19/* "." */,-67 , 33/* "(" */,-67 , 15/* "[" */,-67 , 2/* "IF" */,-67 , 4/* "WHILE" */,-67 , 5/* "DO" */,-67 , 6/* "ECHO" */,-67 , 38/* "Variable" */,-67 , 13/* "{" */,-67 , 46/* "InternalNonScript" */,-67 , 37/* "//" */,-67 , 7/* "RETURN" */,-67 , 8/* "NewToken" */,-67 , 9/* "ClassToken" */,-67 , 39/* "FunctionName" */,-67 , 40/* "Identifier" */,-67 , 30/* "-" */,-67 , 41/* "String" */,-67 , 42/* "Integer" */,-67 , 43/* "Float" */,-67 , 34/* ")" */,-67 , 18/* "," */,-67 , 16/* "]" */,-67 ),
    /* State 128 */ new Array( 8/* "NewToken" */,20 , 38/* "Variable" */,49 , 33/* "(" */,22 , 40/* "Identifier" */,28 , 30/* "-" */,30 , 41/* "String" */,32 , 42/* "Integer" */,33 , 43/* "Float" */,34 ),
    /* State 129 */ new Array( 8/* "NewToken" */,20 , 38/* "Variable" */,49 , 33/* "(" */,22 , 40/* "Identifier" */,28 , 30/* "-" */,30 , 41/* "String" */,32 , 42/* "Integer" */,33 , 43/* "Float" */,34 , 34/* ")" */,-65 , 18/* "," */,-65 ),
    /* State 130 */ new Array( 40/* "Identifier" */,98 , 8/* "NewToken" */,101 , 38/* "Variable" */,103 , 33/* "(" */,104 , 30/* "-" */,30 , 41/* "String" */,32 , 42/* "Integer" */,33 , 43/* "Float" */,34 ),
    /* State 131 */ new Array( 15/* "[" */,91 , 33/* "(" */,-47 , 21/* "==" */,-47 , 28/* "<" */,-47 , 27/* ">" */,-47 , 25/* "<=" */,-47 , 26/* ">=" */,-47 , 22/* "!=" */,-47 , 19/* "." */,-47 , 35/* "->" */,-47 , 2/* "IF" */,-53 , 4/* "WHILE" */,-53 , 5/* "DO" */,-53 , 6/* "ECHO" */,-53 , 38/* "Variable" */,-53 , 13/* "{" */,-53 , 46/* "InternalNonScript" */,-53 , 37/* "//" */,-53 , 7/* "RETURN" */,-53 , 8/* "NewToken" */,-53 , 9/* "ClassToken" */,-53 , 39/* "FunctionName" */,-53 , 40/* "Identifier" */,-53 , 30/* "-" */,-53 , 41/* "String" */,-53 , 42/* "Integer" */,-53 , 43/* "Float" */,-53 , 17/* ";" */,-47 , 34/* ")" */,-53 , 18/* "," */,-53 , 16/* "]" */,-53 , 20/* "=" */,-47 ),
    /* State 132 */ new Array( 33/* "(" */,38 , 19/* "." */,39 , 22/* "!=" */,40 , 26/* ">=" */,41 , 25/* "<=" */,42 , 27/* ">" */,43 , 28/* "<" */,44 , 21/* "==" */,45 , 34/* ")" */,146 , 35/* "->" */,-43 ),
    /* State 133 */ new Array( 17/* ";" */,-50 , 35/* "->" */,-50 , 21/* "==" */,-50 , 28/* "<" */,-50 , 27/* ">" */,-50 , 25/* "<=" */,-50 , 26/* ">=" */,-50 , 22/* "!=" */,-50 , 19/* "." */,-50 , 33/* "(" */,-50 , 2/* "IF" */,-50 , 4/* "WHILE" */,-50 , 5/* "DO" */,-50 , 6/* "ECHO" */,-50 , 38/* "Variable" */,-50 , 13/* "{" */,-50 , 46/* "InternalNonScript" */,-50 , 37/* "//" */,-50 , 7/* "RETURN" */,-50 , 8/* "NewToken" */,-50 , 9/* "ClassToken" */,-50 , 39/* "FunctionName" */,-50 , 40/* "Identifier" */,-50 , 30/* "-" */,-50 , 41/* "String" */,-50 , 42/* "Integer" */,-50 , 43/* "Float" */,-50 , 34/* ")" */,-50 , 18/* "," */,-50 , 16/* "]" */,-50 , 20/* "=" */,-50 ),
    /* State 134 */ new Array( 14/* "}" */,149 , 10/* "PublicToken" */,152 , 12/* "ProtectedToken" */,153 , 11/* "PrivateToken" */,154 , 39/* "FunctionName" */,-12 ),
    /* State 135 */ new Array( 38/* "Variable" */,155 ),
    /* State 136 */ new Array( 13/* "{" */,156 ),
    /* State 137 */ new Array( 33/* "(" */,38 , 19/* "." */,39 , 22/* "!=" */,40 , 26/* ">=" */,41 , 25/* "<=" */,42 , 27/* ">" */,43 , 28/* "<" */,44 , 21/* "==" */,45 , 34/* ")" */,-63 , 18/* "," */,-63 , 35/* "->" */,-43 ),
    /* State 138 */ new Array( 17/* ";" */,-85 , 30/* "-" */,-85 , 29/* "+" */,-85 , 32/* "*" */,-85 , 31/* "/" */,-85 , 35/* "->" */,-85 , 21/* "==" */,-85 , 28/* "<" */,-85 , 27/* ">" */,-85 , 25/* "<=" */,-85 , 26/* ">=" */,-85 , 22/* "!=" */,-85 , 19/* "." */,-85 , 33/* "(" */,-85 , 2/* "IF" */,-85 , 4/* "WHILE" */,-85 , 5/* "DO" */,-85 , 6/* "ECHO" */,-85 , 38/* "Variable" */,-85 , 13/* "{" */,-85 , 46/* "InternalNonScript" */,-85 , 37/* "//" */,-85 , 7/* "RETURN" */,-85 , 8/* "NewToken" */,-85 , 9/* "ClassToken" */,-85 , 39/* "FunctionName" */,-85 , 40/* "Identifier" */,-85 , 41/* "String" */,-85 , 42/* "Integer" */,-85 , 43/* "Float" */,-85 , 34/* ")" */,-85 , 18/* "," */,-85 , 16/* "]" */,-85 , 20/* "=" */,-85 ),
    /* State 139 */ new Array( 2/* "IF" */,7 , 4/* "WHILE" */,8 , 5/* "DO" */,9 , 6/* "ECHO" */,10 , 38/* "Variable" */,11 , 13/* "{" */,15 , 46/* "InternalNonScript" */,16 , 37/* "//" */,17 , 7/* "RETURN" */,18 , 8/* "NewToken" */,20 , 33/* "(" */,22 , 9/* "ClassToken" */,23 , 39/* "FunctionName" */,24 , 40/* "Identifier" */,28 , 30/* "-" */,30 , 41/* "String" */,32 , 42/* "Integer" */,33 , 43/* "Float" */,34 , 45/* "ScriptEnd" */,-23 , 14/* "}" */,-23 , 3/* "ELSE" */,-23 ),
    /* State 140 */ new Array( 45/* "ScriptEnd" */,-25 , 2/* "IF" */,-25 , 4/* "WHILE" */,-25 , 5/* "DO" */,-25 , 6/* "ECHO" */,-25 , 38/* "Variable" */,-25 , 13/* "{" */,-25 , 46/* "InternalNonScript" */,-25 , 37/* "//" */,-25 , 7/* "RETURN" */,-25 , 8/* "NewToken" */,-25 , 33/* "(" */,-25 , 9/* "ClassToken" */,-25 , 39/* "FunctionName" */,-25 , 40/* "Identifier" */,-25 , 30/* "-" */,-25 , 41/* "String" */,-25 , 42/* "Integer" */,-25 , 43/* "Float" */,-25 , 14/* "}" */,-25 , 3/* "ELSE" */,-25 ),
    /* State 141 */ new Array( 20/* "=" */,-66 , 17/* ";" */,-66 , 35/* "->" */,-66 , 21/* "==" */,-66 , 28/* "<" */,-66 , 27/* ">" */,-66 , 25/* "<=" */,-66 , 26/* ">=" */,-66 , 22/* "!=" */,-66 , 19/* "." */,-66 , 33/* "(" */,-66 , 15/* "[" */,-66 , 2/* "IF" */,-66 , 4/* "WHILE" */,-66 , 5/* "DO" */,-66 , 6/* "ECHO" */,-66 , 38/* "Variable" */,-66 , 13/* "{" */,-66 , 46/* "InternalNonScript" */,-66 , 37/* "//" */,-66 , 7/* "RETURN" */,-66 , 8/* "NewToken" */,-66 , 9/* "ClassToken" */,-66 , 39/* "FunctionName" */,-66 , 40/* "Identifier" */,-66 , 30/* "-" */,-66 , 41/* "String" */,-66 , 42/* "Integer" */,-66 , 43/* "Float" */,-66 , 34/* ")" */,-66 , 18/* "," */,-66 , 16/* "]" */,-66 ),
    /* State 142 */ new Array( 45/* "ScriptEnd" */,-31 , 2/* "IF" */,-31 , 4/* "WHILE" */,-31 , 5/* "DO" */,-31 , 6/* "ECHO" */,-31 , 38/* "Variable" */,-31 , 13/* "{" */,-31 , 46/* "InternalNonScript" */,-31 , 37/* "//" */,-31 , 7/* "RETURN" */,-31 , 8/* "NewToken" */,-31 , 33/* "(" */,-31 , 9/* "ClassToken" */,-31 , 39/* "FunctionName" */,-31 , 40/* "Identifier" */,-31 , 30/* "-" */,-31 , 41/* "String" */,-31 , 42/* "Integer" */,-31 , 43/* "Float" */,-31 , 14/* "}" */,-31 , 3/* "ELSE" */,-31 ),
    /* State 143 */ new Array( 33/* "(" */,38 , 19/* "." */,39 , 22/* "!=" */,40 , 26/* ">=" */,41 , 25/* "<=" */,42 , 27/* ">" */,43 , 28/* "<" */,44 , 21/* "==" */,45 , 17/* ";" */,157 , 35/* "->" */,-43 ),
    /* State 144 */ new Array( 18/* "," */,114 , 34/* ")" */,158 ),
    /* State 145 */ new Array( 20/* "=" */,-46 , 17/* ";" */,-46 , 35/* "->" */,-46 , 21/* "==" */,-46 , 28/* "<" */,-46 , 27/* ">" */,-46 , 25/* "<=" */,-46 , 26/* ">=" */,-46 , 22/* "!=" */,-46 , 19/* "." */,-46 , 33/* "(" */,-46 , 2/* "IF" */,-51 , 4/* "WHILE" */,-51 , 5/* "DO" */,-51 , 6/* "ECHO" */,-51 , 38/* "Variable" */,-51 , 13/* "{" */,-51 , 46/* "InternalNonScript" */,-51 , 37/* "//" */,-51 , 7/* "RETURN" */,-51 , 8/* "NewToken" */,-51 , 9/* "ClassToken" */,-51 , 39/* "FunctionName" */,-51 , 40/* "Identifier" */,-51 , 30/* "-" */,-51 , 41/* "String" */,-51 , 42/* "Integer" */,-51 , 43/* "Float" */,-51 , 34/* ")" */,-51 , 18/* "," */,-51 , 16/* "]" */,-51 ),
    /* State 146 */ new Array( 20/* "=" */,-48 , 17/* ";" */,-48 , 35/* "->" */,-48 , 21/* "==" */,-48 , 28/* "<" */,-48 , 27/* ">" */,-48 , 25/* "<=" */,-48 , 26/* ">=" */,-48 , 22/* "!=" */,-48 , 19/* "." */,-48 , 33/* "(" */,-48 , 2/* "IF" */,-54 , 4/* "WHILE" */,-54 , 5/* "DO" */,-54 , 6/* "ECHO" */,-54 , 38/* "Variable" */,-54 , 13/* "{" */,-54 , 46/* "InternalNonScript" */,-54 , 37/* "//" */,-54 , 7/* "RETURN" */,-54 , 8/* "NewToken" */,-54 , 9/* "ClassToken" */,-54 , 39/* "FunctionName" */,-54 , 40/* "Identifier" */,-54 , 30/* "-" */,-54 , 41/* "String" */,-54 , 42/* "Integer" */,-54 , 43/* "Float" */,-54 , 34/* ")" */,-54 , 18/* "," */,-54 , 16/* "]" */,-54 , 29/* "+" */,-85 , 32/* "*" */,-85 , 31/* "/" */,-85 ),
    /* State 147 */ new Array( 14/* "}" */,-6 , 10/* "PublicToken" */,-6 , 12/* "ProtectedToken" */,-6 , 11/* "PrivateToken" */,-6 , 39/* "FunctionName" */,-6 ),
    /* State 148 */ new Array( 14/* "}" */,-5 , 10/* "PublicToken" */,-5 , 12/* "ProtectedToken" */,-5 , 11/* "PrivateToken" */,-5 , 39/* "FunctionName" */,-5 ),
    /* State 149 */ new Array( 45/* "ScriptEnd" */,-4 , 2/* "IF" */,-4 , 4/* "WHILE" */,-4 , 5/* "DO" */,-4 , 6/* "ECHO" */,-4 , 38/* "Variable" */,-4 , 13/* "{" */,-4 , 46/* "InternalNonScript" */,-4 , 37/* "//" */,-4 , 7/* "RETURN" */,-4 , 8/* "NewToken" */,-4 , 33/* "(" */,-4 , 9/* "ClassToken" */,-4 , 39/* "FunctionName" */,-4 , 40/* "Identifier" */,-4 , 30/* "-" */,-4 , 41/* "String" */,-4 , 42/* "Integer" */,-4 , 43/* "Float" */,-4 , 14/* "}" */,-4 , 3/* "ELSE" */,-4 ),
    /* State 150 */ new Array( 38/* "Variable" */,159 ),
    /* State 151 */ new Array( 39/* "FunctionName" */,160 ),
    /* State 152 */ new Array( 38/* "Variable" */,-8 , 39/* "FunctionName" */,-11 ),
    /* State 153 */ new Array( 38/* "Variable" */,-9 , 39/* "FunctionName" */,-13 ),
    /* State 154 */ new Array( 38/* "Variable" */,-10 , 39/* "FunctionName" */,-14 ),
    /* State 155 */ new Array( 34/* ")" */,-38 , 18/* "," */,-38 ),
    /* State 156 */ new Array( 2/* "IF" */,7 , 4/* "WHILE" */,8 , 5/* "DO" */,9 , 6/* "ECHO" */,10 , 38/* "Variable" */,11 , 13/* "{" */,15 , 46/* "InternalNonScript" */,16 , 37/* "//" */,17 , 7/* "RETURN" */,18 , 8/* "NewToken" */,20 , 33/* "(" */,22 , 9/* "ClassToken" */,23 , 39/* "FunctionName" */,24 , 40/* "Identifier" */,28 , 30/* "-" */,30 , 41/* "String" */,32 , 42/* "Integer" */,33 , 43/* "Float" */,34 ),
    /* State 157 */ new Array( 45/* "ScriptEnd" */,-28 , 2/* "IF" */,-28 , 4/* "WHILE" */,-28 , 5/* "DO" */,-28 , 6/* "ECHO" */,-28 , 38/* "Variable" */,-28 , 13/* "{" */,-28 , 46/* "InternalNonScript" */,-28 , 37/* "//" */,-28 , 7/* "RETURN" */,-28 , 8/* "NewToken" */,-28 , 33/* "(" */,-28 , 9/* "ClassToken" */,-28 , 39/* "FunctionName" */,-28 , 40/* "Identifier" */,-28 , 30/* "-" */,-28 , 41/* "String" */,-28 , 42/* "Integer" */,-28 , 43/* "Float" */,-28 , 14/* "}" */,-28 , 3/* "ELSE" */,-28 ),
    /* State 158 */ new Array( 33/* "(" */,-45 , 21/* "==" */,-45 , 28/* "<" */,-45 , 27/* ">" */,-45 , 25/* "<=" */,-45 , 26/* ">=" */,-45 , 22/* "!=" */,-45 , 19/* "." */,-45 , 35/* "->" */,-45 , 2/* "IF" */,-50 , 4/* "WHILE" */,-50 , 5/* "DO" */,-50 , 6/* "ECHO" */,-50 , 38/* "Variable" */,-50 , 13/* "{" */,-50 , 46/* "InternalNonScript" */,-50 , 37/* "//" */,-50 , 7/* "RETURN" */,-50 , 8/* "NewToken" */,-50 , 9/* "ClassToken" */,-50 , 39/* "FunctionName" */,-50 , 40/* "Identifier" */,-50 , 30/* "-" */,-50 , 41/* "String" */,-50 , 42/* "Integer" */,-50 , 43/* "Float" */,-50 , 17/* ";" */,-45 , 34/* ")" */,-50 , 18/* "," */,-50 , 16/* "]" */,-50 , 20/* "=" */,-45 ),
    /* State 159 */ new Array( 17/* ";" */,162 , 20/* "=" */,163 ),
    /* State 160 */ new Array( 33/* "(" */,164 ),
    /* State 161 */ new Array( 14/* "}" */,165 , 2/* "IF" */,7 , 4/* "WHILE" */,8 , 5/* "DO" */,9 , 6/* "ECHO" */,10 , 38/* "Variable" */,11 , 13/* "{" */,15 , 46/* "InternalNonScript" */,16 , 37/* "//" */,17 , 7/* "RETURN" */,18 , 8/* "NewToken" */,20 , 33/* "(" */,22 , 9/* "ClassToken" */,23 , 39/* "FunctionName" */,24 , 40/* "Identifier" */,28 , 30/* "-" */,30 , 41/* "String" */,32 , 42/* "Integer" */,33 , 43/* "Float" */,34 ),
    /* State 162 */ new Array( 14/* "}" */,-17 , 10/* "PublicToken" */,-17 , 12/* "ProtectedToken" */,-17 , 11/* "PrivateToken" */,-17 , 39/* "FunctionName" */,-17 ),
    /* State 163 */ new Array( 8/* "NewToken" */,20 , 38/* "Variable" */,49 , 33/* "(" */,22 , 40/* "Identifier" */,28 , 30/* "-" */,30 , 41/* "String" */,32 , 42/* "Integer" */,33 , 43/* "Float" */,34 ),
    /* State 164 */ new Array( 38/* "Variable" */,111 , 34/* ")" */,-40 , 18/* "," */,-40 ),
    /* State 165 */ new Array( 45/* "ScriptEnd" */,-15 , 2/* "IF" */,-15 , 4/* "WHILE" */,-15 , 5/* "DO" */,-15 , 6/* "ECHO" */,-15 , 38/* "Variable" */,-15 , 13/* "{" */,-15 , 46/* "InternalNonScript" */,-15 , 37/* "//" */,-15 , 7/* "RETURN" */,-15 , 8/* "NewToken" */,-15 , 33/* "(" */,-15 , 9/* "ClassToken" */,-15 , 39/* "FunctionName" */,-15 , 40/* "Identifier" */,-15 , 30/* "-" */,-15 , 41/* "String" */,-15 , 42/* "Integer" */,-15 , 43/* "Float" */,-15 , 14/* "}" */,-15 , 3/* "ELSE" */,-15 ),
    /* State 166 */ new Array( 33/* "(" */,38 , 19/* "." */,39 , 22/* "!=" */,40 , 26/* ">=" */,41 , 25/* "<=" */,42 , 27/* ">" */,43 , 28/* "<" */,44 , 21/* "==" */,45 , 17/* ";" */,168 , 35/* "->" */,-43 ),
    /* State 167 */ new Array( 18/* "," */,135 , 34/* ")" */,169 ),
    /* State 168 */ new Array( 14/* "}" */,-18 , 10/* "PublicToken" */,-18 , 12/* "ProtectedToken" */,-18 , 11/* "PrivateToken" */,-18 , 39/* "FunctionName" */,-18 ),
    /* State 169 */ new Array( 13/* "{" */,170 ),
    /* State 170 */ new Array( 2/* "IF" */,7 , 4/* "WHILE" */,8 , 5/* "DO" */,9 , 6/* "ECHO" */,10 , 38/* "Variable" */,11 , 13/* "{" */,15 , 46/* "InternalNonScript" */,16 , 37/* "//" */,17 , 7/* "RETURN" */,18 , 8/* "NewToken" */,20 , 33/* "(" */,22 , 9/* "ClassToken" */,23 , 39/* "FunctionName" */,24 , 40/* "Identifier" */,28 , 30/* "-" */,30 , 41/* "String" */,32 , 42/* "Integer" */,33 , 43/* "Float" */,34 ),
    /* State 171 */ new Array( 14/* "}" */,172 , 2/* "IF" */,7 , 4/* "WHILE" */,8 , 5/* "DO" */,9 , 6/* "ECHO" */,10 , 38/* "Variable" */,11 , 13/* "{" */,15 , 46/* "InternalNonScript" */,16 , 37/* "//" */,17 , 7/* "RETURN" */,18 , 8/* "NewToken" */,20 , 33/* "(" */,22 , 9/* "ClassToken" */,23 , 39/* "FunctionName" */,24 , 40/* "Identifier" */,28 , 30/* "-" */,30 , 41/* "String" */,32 , 42/* "Integer" */,33 , 43/* "Float" */,34 ),
    /* State 172 */ new Array( 14/* "}" */,-16 , 10/* "PublicToken" */,-16 , 12/* "ProtectedToken" */,-16 , 11/* "PrivateToken" */,-16 , 39/* "FunctionName" */,-16 )
);
...
var goto_tab = new Array(
    ...
    /* State 50 */ new Array( 49/* Stmt */,88 , 59/* Return */,5 , 58/* Expression */,6 , 60/* Target */,12 , 51/* ClassDefinition */,13 , 57/* FunctionDefinition */,14 , 64/* BinaryOp */,19 , 69/* FunctionAccess */,21 , 70/* AddSubExp */,25 , 65/* FunctionInvoke */,26 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    ...
    /* State 87 */ new Array( ),
    /* State 88 */ new Array( 49/* Stmt */,35 , 59/* Return */,5 , 58/* Expression */,6 , 60/* Target */,12 , 51/* ClassDefinition */,13 , 57/* FunctionDefinition */,14 , 64/* BinaryOp */,19 , 69/* FunctionAccess */,21 , 70/* AddSubExp */,25 , 65/* FunctionInvoke */,26 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    /* State 89 */ new Array( 58/* Expression */,123 , 64/* BinaryOp */,19 , 60/* Target */,48 , 69/* FunctionAccess */,21 , 70/* AddSubExp */,25 , 65/* FunctionInvoke */,26 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    /* State 90 */ new Array( ),
    /* State 91 */ new Array( 58/* Expression */,124 , 64/* BinaryOp */,19 , 60/* Target */,48 , 69/* FunctionAccess */,21 , 70/* AddSubExp */,25 , 65/* FunctionInvoke */,26 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    /* State 92 */ new Array( 58/* Expression */,125 , 64/* BinaryOp */,19 , 60/* Target */,48 , 69/* FunctionAccess */,21 , 70/* AddSubExp */,25 , 65/* FunctionInvoke */,26 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    /* State 93 */ new Array( ),
    /* State 94 */ new Array( ),
    /* State 95 */ new Array( ),
    /* State 96 */ new Array( ),
    ...
    /* State 99 */ new Array( ),
    /* State 100 */ new Array( ),
    /* State 101 */ new Array( 65/* FunctionInvoke */,129 , 58/* Expression */,62 , 64/* BinaryOp */,19 , 60/* Target */,48 , 69/* FunctionAccess */,21 , 70/* AddSubExp */,25 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    /* State 102 */ new Array( ),
    /* State 103 */ new Array( 62/* ArrayIndices */,131 ),
    /* State 104 */ new Array( 58/* Expression */,132 , 64/* BinaryOp */,19 , 60/* Target */,48 , 69/* FunctionAccess */,21 , 70/* AddSubExp */,25 , 65/* FunctionInvoke */,26 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    /* State 105 */ new Array( ),
    /* State 106 */ new Array( ),
    /* State 107 */ new Array( ),
    /* State 108 */ new Array( ),
    /* State 109 */ new Array( 50/* Member */,134 ),
    /* State 110 */ new Array( ),
    /* State 111 */ new Array( ),
    /* State 112 */ new Array( ),
    /* State 113 */ new Array( ),
    /* State 114 */ new Array( 58/* Expression */,137 , 64/* BinaryOp */,19 , 60/* Target */,48 , 69/* FunctionAccess */,21 , 70/* AddSubExp */,25 , 65/* FunctionInvoke */,26 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    /* State 115 */ new Array( ),
    /* State 116 */ new Array( ),
    /* State 117 */ new Array( ),
    /* State 118 */ new Array( ),
    /* State 119 */ new Array( ),
    /* State 120 */ new Array( ),
    /* State 121 */ new Array( 49/* Stmt */,139 , 59/* Return */,5 , 58/* Expression */,6 , 60/* Target */,12 , 51/* ClassDefinition */,13 , 57/* FunctionDefinition */,14 , 64/* BinaryOp */,19 , 69/* FunctionAccess */,21 , 70/* AddSubExp */,25 , 65/* FunctionInvoke */,26 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    /* State 122 */ new Array( ),
    /* State 123 */ new Array( 49/* Stmt */,88 , 59/* Return */,5 , 58/* Expression */,6 , 60/* Target */,12 , 51/* ClassDefinition */,13 , 57/* FunctionDefinition */,14 , 64/* BinaryOp */,19 , 69/* FunctionAccess */,21 , 70/* AddSubExp */,25 , 65/* FunctionInvoke */,26 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    /* State 124 */ new Array( ),
    /* State 125 */ new Array( ),
    /* State 126 */ new Array( ),
    /* State 127 */ new Array( ),
    /* State 128 */ new Array( 58/* Expression */,143 , 64/* BinaryOp */,19 , 60/* Target */,48 , 69/* FunctionAccess */,21 , 70/* AddSubExp */,25 , 65/* FunctionInvoke */,26 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    /* State 129 */ new Array( 66/* ActualParameterList */,144 , 58/* Expression */,69 , 64/* BinaryOp */,19 , 60/* Target */,48 , 69/* FunctionAccess */,21 , 70/* AddSubExp */,25 , 65/* FunctionInvoke */,26 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    /* State 130 */ new Array( 67/* MemberAccess */,145 , 69/* FunctionAccess */,97 , 61/* AttributeAccess */,122 , 65/* FunctionInvoke */,26 , 58/* Expression */,62 , 68/* ExpressionNotFunAccess */,99 , 64/* BinaryOp */,100 , 60/* Target */,102 , 70/* AddSubExp */,25 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    /* State 131 */ new Array( ),
    /* State 132 */ new Array( ),
    /* State 133 */ new Array( ),
    /* State 134 */ new Array( 53/* ClassFunctionDefinition */,147 , 52/* AttributeDefinition */,148 , 54/* AttributeMod */,150 , 55/* FunctionMod */,151 ),
    /* State 135 */ new Array( ),
    /* State 136 */ new Array( ),
    /* State 137 */ new Array( ),
    /* State 138 */ new Array( ),
    /* State 139 */ new Array( 49/* Stmt */,35 , 59/* Return */,5 , 58/* Expression */,6 , 60/* Target */,12 , 51/* ClassDefinition */,13 , 57/* FunctionDefinition */,14 , 64/* BinaryOp */,19 , 69/* FunctionAccess */,21 , 70/* AddSubExp */,25 , 65/* FunctionInvoke */,26 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    /* State 140 */ new Array( ),
    /* State 141 */ new Array( ),
    /* State 142 */ new Array( ),
    /* State 143 */ new Array( ),
    ...
    /* State 154 */ new Array( ),
    /* State 155 */ new Array( ),
    /* State 156 */ new Array( 49/* Stmt */,161 , 59/* Return */,5 , 58/* Expression */,6 , 60/* Target */,12 , 51/* ClassDefinition */,13 , 57/* FunctionDefinition */,14 , 64/* BinaryOp */,19 , 69/* FunctionAccess */,21 , 70/* AddSubExp */,25 , 65/* FunctionInvoke */,26 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    /* State 157 */ new Array( ),
    /* State 158 */ new Array( ),
    /* State 159 */ new Array( ),
    /* State 160 */ new Array( ),
    /* State 161 */ new Array( 49/* Stmt */,35 , 59/* Return */,5 , 58/* Expression */,6 , 60/* Target */,12 , 51/* ClassDefinition */,13 , 57/* FunctionDefinition */,14 , 64/* BinaryOp */,19 , 69/* FunctionAccess */,21 , 70/* AddSubExp */,25 , 65/* FunctionInvoke */,26 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    /* State 162 */ new Array( ),
    /* State 163 */ new Array( 58/* Expression */,166 , 64/* BinaryOp */,19 , 60/* Target */,48 , 69/* FunctionAccess */,21 , 70/* AddSubExp */,25 , 65/* FunctionInvoke */,26 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    /* State 164 */ new Array( 56/* FormalParameterList */,167 ),
    /* State 165 */ new Array( ),
    /* State 166 */ new Array( ),
    /* State 167 */ new Array( ),
    /* State 168 */ new Array( ),
    /* State 169 */ new Array( ),
    /* State 170 */ new Array( 49/* Stmt */,171 , 59/* Return */,5 , 58/* Expression */,6 , 60/* Target */,12 , 51/* ClassDefinition */,13 , 57/* FunctionDefinition */,14 , 64/* BinaryOp */,19 , 69/* FunctionAccess */,21 , 70/* AddSubExp */,25 , 65/* FunctionInvoke */,26 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    /* State 171 */ new Array( 49/* Stmt */,35 , 59/* Return */,5 , 58/* Expression */,6 , 60/* Target */,12 , 51/* ClassDefinition */,13 , 57/* FunctionDefinition */,14 , 64/* BinaryOp */,19 , 69/* FunctionAccess */,21 , 70/* AddSubExp */,25 , 65/* FunctionInvoke */,26 , 71/* MulDivExp */,27 , 72/* UnaryOp */,29 , 73/* Value */,31 ),
    /* State 172 */ new Array( )
);
...
{ act = 174; for( var i = 0; i < act_tab[sstack[sstack.length-1]].length; i+=2 )
...
info.offset++; while( act == 174 && sstack.length > 0 )
{ sstack.pop(); vstack.pop(); if( sstack.length == 0 )
break; act = 174; for( var i = 0; i < act_tab[sstack[sstack.length-1]].length; i+=2 )
{ if( act_tab[sstack[sstack.length-1]][i] == la )
{ act = act_tab[sstack[sstack.length-1]][i+1]; break;}
}
}
